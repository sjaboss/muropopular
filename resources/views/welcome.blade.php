            ...
            <div
                ...
                <div class="rounded-lg border shadow border-emerald-600 p-2">
                    ...
                    <a href="{{ route('sociedadSep.show', $tituloSep) }}">
                        <img class="h-48 w-full object-cover object-center rounded-lg" src="../img/soc/soc_ia.svg"
                            alt="Imagen Nota 1">
                    </a>
                    <div class="py-4 px-6">
                    ...
                    <div class="py-4 px-6">
                        <h1 class="text-lg font-serif">
                            <a href="{{ route('interSepNew.show', $tituloSep) }}">
                                Programa Fantasma ADN y Radio La Turba.
                            </a>
                        </h1>
            </div>
        </div> 
                                    ...
                                    <div class="pt-2 text-emerald-500">
                                        <h2>
                                            ...
                                            <h1 class="text-lg font-serif animate-fade-right text-white pt-2">
                                                <a href="{{ route('sociedadSep.show', $tituloSep) }}">PARO NACIONAL DE
                                    ...
                                    <div class="pt-2 text-emerald-500">
                                        <h2>
                                            ...
                                            <h1 class="text-lg font-serif animate-fade-right text-white pt-2">
                                                ...
                                                <a href="{{ route('legislaturaSep.show', $tituloSep) }}">LA LEGISLATURA
                        ...
                        <ul class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 py-6">
                                    ...
                                    <div class="pt-2 text-emerald-500">
                                        <h2>
                                            ...
                                            <h1 class="text-lg font-serif animate-fade-right text-white">
                                                <a href="{{ route('politicaSep.show', $tituloSep) }}">EL GOBIERNO DE
                                                    MILEI LLAMA ‘FALKLANDS’ A LAS MALVINAS, UN ERROR QUE ESCONDE UNA
                                                    TRAICION
                                ...
                                <div class=" py-2 px-2 bg-gray-800">
                                    <div class="pt-2 text-emerald-500">
                                        <h2>
                                            ...
                                            <a href="{{ route('interSepNew.show', $tituloSep) }}">
                                                <img class=" h-56  w-full object-cover rounded-lg border-gray-900 "
                                                    alt="" src="{{ asset('../img/int/int_eeuu.svg') }}">
                                            </a>
                                            <h1 class="text-lg font-serif animate-fade-right text-white">
                                                <a href="{{ route('interSepNew.show', $tituloSep) }}">ELECCIÓN
                                                    PRESIDENCIAL CON FINAL ABIERTO ENTRE TRUMP Y HARRIS
                                                </a>
                                            </h1>
                            ...
                            <li class="rounded-lg  border shadow border-emerald-600">
                                <div class=" py-2 px-2 bg-gray-800">
                                    ...
                                    <a href="{{ route('legislaturaSep.show', $tituloSep) }}">
                                        <img class="h-48 w-full object-cover object-center rounded-lg"
                                            src="{{ asset('../img/leg/leg_digital.svg') }}" alt="">
                                    </a>
                                    <div class="py-4 px-6">
                                        <h1 class="text-lg font-serif">
                                            <a href="{{ route('legislaturaSep.show', $tituloSep) }}">
                                                LOS DESAFÍOS DE LA DEMOCRACIA EN LA ERA DIGITAL: JORNADA EN LA
                                                LEGISLATURA PORTEÑA
                                            </a>
                                            {{--   <p class="font-light  text-lef text-gray-500">Por Gustavo Cano</p> --}}
                                    </div>
                            ...
                            <li class="rounded-lg  border shadow border-emerald-600">
                                <div class=" py-2 px-2 bg-gray-800">
                                    ...
                                    <a href="{{ route('sociedadSep.show', $tituloSep) }}">
                                        <img class="h-48 w-full object-cover object-center rounded-lg"
                                            src="{{ asset('../img/soc/soc_grandes.svg') }}" alt="">
                                    </a>
                                    <div class="py-4 px-6">
                                        <h1 class="text-lg font-serif">
                                            <a href="{{ route('sociedadSep.show', $tituloSep) }}">
                                                GRANDES CORPORACIONES DUPLICAN RENTABILIDAD MIENTRAS SE DERRUMBAN
                                                INGRESOS POPULARES
                                            </a>
                                            {{--   <p class="font-light  text-lef text-gray-500">Por Gustavo Cano</p> --}}
                                        </h1>
                        ...
                        <ul class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 py-6">
                                ...
                                <div class=" py-2 px-4">
                                    <div class="pt-2 text-emerald-500">
                                        <h2>
                                            ...
                                            <h1 class="text-lg font-serif animate-fade-right text-white">
                                                <a href="{{ route('feministaSep.show', $tituloSep) }}">LAS PROVINCIAS
                                    ...
                                    <div class="pt-2 text-emerald-500">
                                        <h2>
                                            ...
                                            <a href="{{ route('derechoSep.show', $tituloSep) }}">
                                                <img class=" h-56  w-full object-cover rounded-lg border-gray-900 "
                                                    alt="a1" src="{{ asset('../img/der/der_violencia.svg') }}">
                                            </a>
                                            <h1 class="text-lg font-serif animate-fade-right text-white">
                                                <a href="{{ route('derechoSep.show', $tituloSep) }}">VIOLENCIA VERBAL
                                                    DEL PRESIDENTE: REPUDIO DE
                                                    ORGANISMOS DE DDHH
                                                </a>
                                            </h1>
                            ...
                            <li class="rounded-lg  border shadow border-emerald-600">
                                <div class=" py-2 px-2 bg-gray-800">
                                    ...
                                    <a href="{{ route('economiaSep.show', $tituloSep) }}">
                                        <img class="h-48 w-full object-cover object-center rounded-lg"
                                            src="{{ asset('../img/eco/eco_resesion.svg') }}" alt="">
                                    </a>
                                    <div class="py-4 px-6">
                                        <h1 class="text-lg font-serif">
                                            <a href="{{ route('economiaSep.show', $tituloSep) }}">
                            ...
                            <li class="rounded-lg  border shadow border-emerald-600">
                                <div class=" py-2 px-2 bg-gray-800">
                                    ...
                                    <a href="{{ route('economiaSep.show', $tituloSep) }}">
                                        <img class="h-48 w-full object-cover object-center rounded-lg"
                                            src="{{ asset('../img/eco/eco_fmiAposto.svg') }}" alt="">
                                    </a>
                                    <div class="py-4 px-6">
                                        <h1 class="text-lg font-serif">
                                            <a href="{{ route('economiaSep.show', $tituloSep) }}">
                        ...
                        <ul class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 py-6">
                                ...
                                <div class=" py-2 px-4">
                                    <div class="pt-2 text-emerald-500">
                                        <h2>
                                            ...
                                            <h1 class="text-lg font-serif animate-fade-right text-white">
                                                <a href="{{ route('derechoSep.show', $tituloSep) }}">40 AÑOS DEL
                                                    ÍNDICE DE ABUELIDAD: LA LUCHA POR LOS NIETOS QUE FALTAN </a>
                                                {{-- <p class="font-light text-gray-500">Por Jorge Rachid --}}
                                                </p>
                                            </h1>
                                            <a href="{{ route('derechoSep.show', $tituloSep) }}">Ir a la
                                ...
                                <div class=" py-2 px-2 bg-gray-800">
                                    <div class="pt-2 text-emerald-500">
                                        <h2>
                                            ...
                                            <a href="{{ route('sociedadSep.show', $tituloSep) }}">
                                                <img class=" h-56  w-full object-cover rounded-lg border-gray-900 "
                                                    alt="a1" src="{{ asset('../img/soc/soc_arsat.svg') }}">
                                            </a>
                                            <h1 class="text-lg font-serif animate-fade-right text-white">
                                                <a href="{{ route('sociedadSep.show', $tituloSep) }}">EL GOBIERNO
                                                    PRIVATIZA FRECUENCIAS Y PONE EN RIESGO EL FUTURO DE ARSAT
                                                </a>
                                            </h1>
                                            <a href="{{ route('sociedadSep.show', $tituloSep) }}">Ir a la
                                                Noticía</a>
                            ...
                            <li class="rounded-lg  border shadow border-emerald-600">
                                <div class=" py-2 px-2 bg-gray-800">
                                    ...
                                    <a href="{{ route('legislaturaSep.show', $tituloSep) }}">
                                        <img class="h-48 w-full object-cover object-center rounded-lg"
                                            src="{{ asset('../img/leg/leg_LuchaCancer.svg') }}" alt="">
                                    </a>
                                    <div class="py-4 px-6">
                                        <h1 class="text-lg font-serif">
                                            <a href="{{ route('legislaturaSep.show', $tituloSep) }}">
                            ...
                            <li class="rounded-lg  border shadow border-emerald-600">
                                <div class=" py-2 px-2 bg-gray-800">
                                    ...
                                    <div class="py-4 px-6">
                                        <h1 class="text-lg font-serif">
                                            <a href="{{ route('derechoSep.show', $tituloSep) }}">
                                                UN ABRAZO PARA ABUELAS: CONVOCAN A VISIBILIZAR LA BÚSQUEDA DE LOS NIETOS
                                                DESAPARECIDOS
                                            </a>
                                            {{--   <p class="font-light  text-lef text-gray-500">Por Gustavo Cano</p> --}}
                                        </h1>
                                ...
                                <div class=" py-2 px-4">
                                    <div class="pt-2 text-emerald-500">
                                        <h2>
                                            ...
                                            <h1 class="text-lg font-serif animate-fade-right text-white">
                                                <a href="{{ route('politicaSep.show', $tituloSep) }}">ALFONSÍN Y
                                                    SARAVIA RECLAMAN UNIDAD
                                ...
                                <div class=" py-2 px-2 bg-gray-800">
                                    <div class="pt-2 text-emerald-500">
                                        <h2>
                                            ...
                                            <h1 class="text-lg font-serif animate-fade-right text-white">
                                                <a href="{{ route('politicaSep.show', $tituloSep) }}">MILEI AMENAZA A
                                                    LA DEMOCRACIA CON SU DISCURSO DE ODIO
                                                </a>
                                            </h1>
                                            <a href="{{ route('politicaSep.show', $tituloSep) }}">Ir a la
                                                Noticía</a>
                    ...
                    <section>
                        <ul class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-2  gap-6 py-4">
                            ...
                            <div>
                                <article>
                                    <iframe class="w-full aspect-video"
                                        src="https://www.youtube.com/embed/HWemIM7ML-E" title="YouTube video player"
                                        frameborder="0"
                                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                        allowfullscreen></iframe>
                                </article>
