{{-- 
   <section class="bg-gray-900  ">
        <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
            ...
            <form class="space-y-8" action="{{ route('nuestros.store') }}" method="POST" novalidate>
                @csrf
                <div>
                    <label for="email" class="block mb-2 text-sm font-medium text-gray-300">Tu
                        correo</label>
                    <input type="email" id="email" name="email" autofocus
                        class="shadow-sm  border border-gray-600  text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 bg-gray-700 placeholder-gray-400 text-white focus:ring-primary-500 focus:border-primary-500 shadow-sm-light"
                        placeholder="nombre@flowbite.com" required>
                </div>
                <div>
                    <label for="name" class="block mb-2 text-sm font-medium  text-gray-300">Tu
                        Nombre</label>
                    <input type="text" id="name" name="name"
                        class=" @error('name') @enderror  block p-3 w-full text-sm   rounded-lg border  shadow-sm focus:ring-primary-500 focus:border-primary-50 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-primary-500 focus:border-primary-500 shadow-sm-light"
                ...
                <div class="sm:col-span-2">
                    <label for="mensaje" class="block mb-2 text-sm font-medium text-gray-400">Dejános tu
                        mensaje</label>
                    <textarea id="mensaje" name="mensaje" rows="3"
                        ...
                        placeholder="Cuerpo del mensaje"></textarea>
                </div>
                ...
                <button type="submit"
                    class="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 bg-primary-600 hover:bg-primary-700 focus:ring-primary-800">Enviar</button>
            </form>
        </div>
    </section> --}}
    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center">© 2023 <a
                    class="hover:underline">Cooperativa de Trabajo LTDA</a>. El Faro Comunicaciones.
