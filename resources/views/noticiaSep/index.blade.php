                                                ...
                                                <div class="swiper-slide">
                                                    <div>
                                                        <img src="{{ asset('storage') . '/' . $publicidad->foto }}"
                                                            ...
                                                            class="mx-auto img-fluid d-block my-0">
                                                        <!-- Agregué my-0 aquí -->
                                                    </div>
                                                </div>
                                            @endforeach
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Notas de la sección</h4>
                                    <form action="{{ route('seccion', $seccion_obj->seccion) }}" method="get"
                                        class="d-inline-flex">
                                        <input type="text" style="width: 200px" class="form-control flex"
                                            id="titulo" name="titulo" placeholder="Título"
                                            value="{{ request()->titulo }}">
                                        <button type="submit" class="btn btn-primary">Buscar</button>
                                    </form>
                                    @if (request()->titulo || request()->fecha)
                                                            ...
                                                            <div class="swiper-slide">
                                                                <div class="nav-slide-item">
                                                                    <a
                                                                        ...
                                                                        <img class="img-fluid w-100 h-100 object-cover"
