    ...
    <div class="container mx-auto p-4">
        <div class="flex flex-col">
            <div class="bg-white rounded-lg shadow-md p-4">
                ...
                <div class="card-body">
                    <form class="row gy-1" method="POST" action="{{ route('noticias.update', $noticias->id) }}"
                        ...
                        <div class="flex mb-4">
                            <div class="w-1/2 mr-4">
                                ...
                                <input type="date" class="form-control @error('fecha') border-red-500 @enderror"
                                    id="fecha" name="fecha" value="{{ old('fecha', $noticias->fecha) }}"required
                                    autofocus>
                                @error('fecha')
                        ...
                        <div class="flex flex-col mb-4">
                            ...
                            <input type="text" class="form-control @error('titulo') border-red-500 @enderror"
                                id="titulo" name="titulo" value="{{ old('fecha', $noticias->titulo) }}" required>
                            @error('titulo')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="flex flex-col mb-4">
                            ...
                            <textarea cols="30" rows="2" type="text" class="form-control @error('bajada') border-red-500 @enderror"
                                id="bajada" name="bajada" required>{{ old('bajada', $noticias->bajada) }}</textarea>
                            @error('bajada')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="flex flex-col mb-4">
                            ...
                            <textarea cols="30" rows="12" type="text" class="form-control @error('nota') border-red-500 @enderror"
                                id="nota" name="nota" required>{{ old('nota', $noticias->nota) }}</textarea>
                            @error('nota')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="flex flex-col mb-4">
                            ...
                            <input type="text" class="form-control @error('autor') border-red-500 @enderror"
                                id="autor" name="autor" value="{{ old('autor', $noticias->autor) }}" required>
                            @error('autor')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
