    ...
    <div class="container mx-auto p-4">
        <div class="flex flex-col">
            <div class="bg-white rounded-lg shadow-md p-4">
                ...
                <form class="flex flex-col" method="POST" action="{{ route('videos.update', $videos) }}"
                    ...
                    <div class="w-full ">
                        ...
                        <input type="date" class="form-control @error('fecha') is-invalid @enderror" id="fecha"
                            name="fecha" value="{{ old('fecha', $videos->fecha) }}" required autofocus>
                        @error('fecha')
                    ...
                    <div class=" w-full p-2">
                        ...
                        <input type="text" class="form-control w-full @error('src') is-invalid @enderror"
                            id="src" name="src" value="{{ old('src', $videos->src) }}" required></input>
                        @error('src')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class=" w-full p-2">
                        ...
                        <input type="text" class="form-control w-full @error('pie') is-invalid @enderror"
                            id="pie" name="pie" value="{{ old('pie', $videos->pie) }}" required></input>
                        @error('pie')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
