<x-app-layout>
    <div class="container ">
        <div class="mt-10"></div>
        @if ($tituloSep == 'Economia-Noticia-Completa-eco1')
            <section>
                                ...
                                <article>
                                    ...
                                    <div class="py-4 px-4 justify-between items-center">
                                        <h2 class="text-xl font-serif  font-bold pb-6">
                                            <a href="">LA FUNCIÓN DE LOS OUTSIDERS. UNA LECTURA DE ECONOMÍA
                                                POLÍTICA</a>
                                        </h2>
                                        <p>El sorpresivo batacazo electoral de la versión nacional del neofascismo de
                                        ...
                                        <br>
                                        <figure>
                                            <img class=" w-full object-cover" src="../img/eco/eco_largo.svg"
                                                alt="">
                                        </figure>
                                        <br>
                                        <div
                                            ...
                                            <div class=" font-sans text-lg text-left col-span-6  ">
                                                <p>Las líneas de análisis más desarrolladas en el leve interregno entre
                                                    ...
                                                    refundacionales de largo plazo.</p>
                                                <br>
                                                <p>Uno de los análisis más claros y contundentes, formulado en agosto
                                                    ...
                                                    diversas causas de corrupción y delitos de lesa humanidad.</p>
                                                <br>
                                                <p>En ese largo y oscuro período el Perú fue sometido a una serie de
                                                ...
                                                <br>
                                                <p>Como Bolsonaro en Brasil, por poner un ejemplo reciente, los
                                                    ...
                                                    brasileño va a seguir un camino parecido.</p>
                                                <br>
                                                <p>La cuestión central a responder en Argentina 2024 es cuales son los
                                                ...
                                                <br>
                                                <p>Desde su constitución hasta hoy los mecanismos del estado nacional
                                                    ...
                                                    renta agraria y su destino como capital económico.</p>
                                                <br>
                                                <p>Desde el punto de vista conceptual la capitalización de la renta
                                                    ...
                                                    principales diferencias son:</p>
                                                <br>
                                                <p>1. La actividad agropecuaria se hace sobre la base de un recurso
                                                    ...
                                                    absolutas a partir de la retención del producto.</p>
                                                <br>
                                                <p>2. El grado de dispersión territorial. La actividad agropecuaria se
                                                    ...
                                                    el agro y en la ganadería que en el petróleo.</p>
                                                <br>
                                                <p>3. La concentración económica. Debido al monto de inversión y al
                                                    ...
                                                    asimetría en el poder de negociación entre ambas partes.</p>
                                                <br>
                                                <p>4. El régimen de propiedad. En la actividad agropecuaria el
                                                    ...
                                                    objetivos.</p>
                                                <br>
                                                <p>De lo expuesto se desprende que un estado organizado en torno de la
                                                    ...
                                                    centralización del poder económico y político.</p>
                                                <br>
                                                <p>Argentina 2024 está en una encrucijada dado que posee un estado
                                                    ...
                                                    de poder concentrado.</p>
                                                <br>
                                                <p>Hasta aquí el panorama conduce inexorablemente hacia el subdesarrollo
                                                    ...
                                                    inclinar la balanza a favor de Argentina-Noruega.</p>
                                                <br>
                                                <p>Por el contrario, el modelo de concentración económica ejemplificado
                                                ...
                                                <br>
                                                <p>En este escenario, el bloque popular debería tener una estrategia de
                                                    ...
                                                    agro petrolera. Antes de que sea tarde.</p>
                                                <br>
                                                <figure>
                                                    {{-- <img class="w-28 h-28  "
        ...
        @elseif ($tituloSep == 'Economia-Noticia-Completa-eco2')
            <section>
                <div class="grid grid-cols-1 pl-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 shrink-0 ">
                    <div class=" col-span-4">
        ...
        @elseif ($tituloSep == 'Economia-Noticia-Completa-eco3')
            <section>
                <div class="grid grid-cols-1 pl-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 shrink-0 ">
                    <div class=" col-span-4">
        ...
        @elseif ($tituloSep == 'Economia-Noticia-Completa-eco4')
            <section>
                <div class="grid grid-cols-1 pl-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 shrink-0 ">
                    <div class=" col-span-4">
        ...
        @elseif ($tituloSep == 'Economia-Noticia-Completa-eco5')
            <section>
                <div class="grid grid-cols-1 pl-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 shrink-0 ">
                    <div class=" col-span-4">
        ...
        @elseif ($tituloSep == 'Economia-Noticia-Completa-eco6')
            <section>
                <div class="grid grid-cols-1 pl-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 shrink-0 ">
                    <div class=" col-span-4">
        ...
        @elseif ($tituloSep == 'Economia-Noticia-Completa-eco7')
            <section>
                <div class="grid grid-cols-1 pl-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 shrink-0 ">
                    <div class=" col-span-4">
