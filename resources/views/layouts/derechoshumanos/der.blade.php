...
{{-- EL ESTADO APUNTA A VENDER LA PERLA Y OTROS SITIOS HISTÓRICOS --}}
<section>
            <ul>
                <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                    <article>
...
<section>
    <ul>
        ...
        {{--   DIPUTADOS DE MILEI REAVIVAN LA TEORÍA DE LOS DOS DEMONIOS --}}
<section>
    <ul>
        <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
            <article>
        ...
        {{--    LEGISLADORES Y ORGANISMOS EXIGEN LIBERTAD DE LOS DETENIDOS --}}
<section>
    <ul>
        <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
            <article>
        ...
        {{--    ALERTA Y CRÍTICAS ANTE EL CONTROL ESTATAL DE TERRORISTAS --}}
<section>
    <ul>
        <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
            <article>
    ...
    {{--    ADIÓS A LITA BOITANO, INCANSABLE DEFENSORA DE LOS DDHH. --}}
<section>
    <ul>
        ...
        {{--    NORA CORTIÑAS, EMBLEMA DE MADRES DE PLAZA DE MAYO, FALLECIÓ A LOS 94 AÑOS. --}}
<section>
    <ul>
        <li class=" bg-white rounded-lg shadow ">
            <article>
        ...
        {{--     UN RETROCESO PELIGROSO EN LAS POLÍTICAS DE MEMORIA.. --}}
<section>
    <ul>
                            <li class=" bg-white rounded-lg shadow ">
                                <article>
...
<section>
    <ul>
        ...
        {{--      HISTÓRICA SENTENCIA EN EL JUICIO DE LAS BRIGADAS.... --}}
<section>
    <ul>
        <li class=" bg-white rounded-lg shadow ">
            <article>
...
<br><br>
         {{--      LA LUCHA POR LA MEMORIA EN PELIGRO --}}
<section>
    <ul>
        <li class=" bg-white rounded-lg shadow ">
            <article>
                <div class="py-4 px-4 justify-between items-center">
                    <h2 class="text-xl font-serif  font-bold pb-6">
                        <a href="">LA LUCHA POR LA MEMORIA EN PELIGRO
                        </a>
                    ...
                    <div
                        ...
                        <div class=" font-sans text-lg text-left col-span-6  ">
                            ...
                            <p><i>Los despidos en la Secretaría de Derechos Humanos de la Nación generan preocupación en los organismos de derechos humanos, quienes alertan sobre el riesgo de interrupción de las tareas en los sitios de memoria.</i></p>
                            <br>
                            <figure>
                                <a href="">
                                    <img class="w-full object-cover object-center"
                                        src="{{ asset('../img/der/der_lucha2.svg') }}"alt="">
                                </a>
                            </figure>
                            {{-- <p class="font-light text-gray-500">Foto: La Tinta</p> --}}
                            <br>
                            <p>La Secretaría de Derechos Humanos de la Nación enfrenta una situación crítica con los recientes despidos de trabajadores, incluyendo personal del ex centro clandestino de detención Club Atlético, en pleno gobierno de Javier Milei y Victoria Villarruel. Desde el lunes, siete trabajadores han sido cesanteados, sumándose a otros despidos en áreas clave como Comunicación y Leyes Reparatorias.
                            </p>
                            <br>
                            <p>La decisión de avanzar en una "reestructuración" en la Secretaría, supuestamente bajo la orden del ministro de Justicia, Mariano Cúneo Libarona, ha generado rechazo y preocupación en los organismos de derechos humanos. En un comunicado conjunto, expresen su temor ante el "peligro de interrupción" de las tareas en los sitios de memoria, esenciales para mantener viva la memoria histórica del país.</p>
                            <br>
                            <p>La falta de transparencia y comunicación por parte de las autoridades, sumado al hecho de que Alberto Baños, responsable de las decisiones, estaba fuera del país, ha generado un clima de incertidumbre y descontento entre los trabajadores y los organismos de derechos humanos.</p>
                            <br>
                            <p>La coordinadora de la Asamblea Permanente por los Derechos Humanos (APDH) en el Club Atlético, Soledad Astudillo, denunció la falta de respuesta a los reclamos y necesidades de los sitios de memoria, como el mantenimiento y la preservación de los lugares históricos.
                            </p>
                            <br>
                                    ...
                                    <figure>
                                        <a href="">
                                            <img class="h-96  w-full object-cover object-center"
                                                src="{{ asset('../img/der/der_nunca.svg') }}"alt="">
                                        </a>
                                    </figure>
                                    <br>
                                    <p>Ante el intento de Disfrazar de homenaje la reivindicación del
                                        terrorismo de Estado desde ADN Popular – Cooperativa el Faro
                                        Comunicaciones, expresamos.</p>
                                    <br>

                                    <p>Aún hoy, muchos y muchas siguen sosteniendo y banalizando los
                                        crímenes de lesa humidad. Banalizar, trivializar o directamente
                                        negar convencidos de narrativas mentirosas que los medios
                                        hegemónicos hábilmente instalaron. Que el Terrorismo de Estado haya
                                        sido una etapa oscura y feroz de nuestra de historia más reciente
                                        sólo 49 años atrás (1976/1983), es negar el sufrimiento de miles y
                                        millones de argentinos y argentinas que padecieron en carne propia
                                        las más atroces torturas y les otres, la persecución y el constante
                                        terrorismo de Estado, sin saber si el día de mañana seguirían con
                                        vida, y en todo caso en qué condiciones.
                                    </p>

                                    <p>Con la vuelta de una derecha feroz y vengativa, como método
                                        disciplinador, tan semejante a la República de Weimar nacida en
                                        Alemania en las postrimerías de la Primera Guerra Mundial, y aunque
                                        fue un período democrático, se caracterizó por la gran inestabilidad
                                        política y social, en el que con grandes influencias derechistas y
                                        grandes intervenciones de los gigantes grupos económicos intentaron
                                        triunfar en lo político estableciendo un nuevo régimen. Lo lograron.
                                        A la historia nos remitimos. Muchos nos dirán…pero no es lo mismo… y
                                        no…, pero cuánto se le parece! </p>

                                    <p>Negar los crímenes de lesa humanidad es la lisa y llana ofensa a la
                                        humanidad toda.</p>

                                    <p>No podemos permitir los discursos de odio, ni las narrativas falsas
                                        de un “nuevo orden social”. Dudar de la historia es dudar de la
                                        verdad, es escuchar esos cantos de sirena que estupidizan e
                                        infantilizan al pueblo. Tenemos la obligación de contar la verdad de
                                        lo ocurrido, no sólo durante nuestra dictadura cívico militar
                                        eclesial, sino los hechos de la historia de la humidad que se
                                        repiten y se replican si no ponemos un coto a tanto odio.</p>

                                    <p>Por eso consideramos necesaria una ley que penalice el negacionismo
                                        del Terrorismo de Estado en la Argentina, como en tantos países del
                                        mundo que ya la tienen instaurada como delito. </p>

                                    <p>Qué más hace falta? Que aparezca un o una que levente el brazo
                                        izquierdo y vocifere HEIL…mientras las multitudes responden
                                        alborozadas, apasionadas y totalmente obnubiladas desconociendo su
                                        destino. No queremos ninguna estrella amarilla sobre nuestro pecho.
                                        De nosotres depende.</p>
            ...
            <ul>
                <li class=" bg-white rounded-lg shadow ">
                    <article>
                        <div class="py-4 px-4 justify-between items-center">
                            <h2 class="text-xl font-serif  font-bold pb-6">
                                <a href="">COMUNICADO DE LOS ORGANISMOS DE DERECHOS
                                    HUMANOS
                                </a>
                            </h2>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 shrink-0 ">
                                <div class=" font-sans text-lg text-left col-span-6  ">
                                    ...
                                    <figure>
                                        <a href="">
                                            <img class="h-96  w-full object-cover object-center"
                                                src="{{ asset('../img/der/der_repudio.svg') }}"alt="">
                                        </a>
                                    </figure>
                                    <br>
                                    <p>Los Organismos de Derechos Humanos abajo firmantes convocamos a
                                        encontrarnos el<strong> lunes 4/9 en las puertas de la Legislatura, Perú
                                            160, CABA</strong>, a
                                        las 16.30hs,<strong> para expresar nuestro más enérgico repudio a la
                                            pretensión de
                                            llevar cabo en la Legislatura porteña, un acto homenaje a &quot;las
                                            víctimas del
                                            terrorismo&quot; y decimos que no hubo dos demonios y el único
                                            terrorismo fue el
                                            que llevó adelante el Estado genocida.</strong> </p>
                                    <br>

                                    <p>Exigimos que se adopten todas las medidas necesarias para evitar que
                                        esa
                                        provocación se materialice, que no sólo niega y falsea la verdad
                                        histórica sino
                                        que ofende la memoria colectiva, y demandamos que las autoridades y
                                        el pleno
                                        de ese cuerpo legislativo, como de todo el arco político, las
                                        organizaciones
                                        sociales, estudiantiles y sindicales, que efectivamente aspiran a
                                        consolidar el
                                        estado de Derecho y la Democracia, que tanto nos costara recuperar,
                                        se
                                        expresen en idéntico sentido.
                                    </p>
                                    <br>
                                    <p><strong> Son 30.000!</strong></p>
                                    <p><strong> Fue genocidio!</strong></p>
                                    <br>
                                    <p>Madres de Plaza de Mayo Línea Fundadora </p>
            ...
            <ul>
                <li class=" bg-white rounded-lg shadow ">
                    <article>
                        ...
                        <div class="py-4 px-4 justify-between items-center">
                            <h2 class="text-xl font-serif  font-bold pb-6">
                                <a href="">LA NOCHE DE LAS CORBATAS Y LA ACTUALIDAD DE SUS MOTIVOS
                                </a>
                            </h2>

                            <p>La Agencia TELAM define en una nota publicada años atrás: “La Noche de las Corbatas"
                                es el nombre con el que los represores bautizaron una serie de secuestros y
                                ejecuciones de abogados laboralistas ocurridas en Mar del Plata, entre el 6 y el 8
                                de julio de 1977.. </p>

                            <figure>
                                <img class=" w-full object-cover h-50"
                                    src="{{ asset('img/der/izquier-3_der_corbatas_2.svg') }}" alt="">
                            </figure>
                            <br>
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 shrink-0 ">
                                <div class=" font-sans text-lg text-left col-span-6  ">
                                    <p>En efecto esa obra maestra del terror que un grupo de tareas de la Fuerza
                                        Aérea ejecutó en Mar del Plata HACE 46 AÑOS hoy, se llevó la vida previo
                                        martirio descarnado de Norberto Centeno, Salvador Arestín, Raúl Alaiz, Tomás
                                        Fresneda, María de las Mercedes Argañaraz de Fresneda, Néstor García
                                        Mantica, Y María Esther Vázquez de García.
                                    </p>
                                    <br>
                                    <p>Para mayores datos, tratando de ser breve, Norberto Centeno fue autor del
                                        anteproyecto de la Ley de Contrato de Trabajo, una herramienta ejemplo de
                                        defensa de los derechos de los trabajadores a nivel internacional, además de
                                        su destacada labor como abogado de varios gremios.
                                    </p>

                                    <br>
                                    <p>Los abogados desaparecidos entre el 7 y el 13 de julio del 76, eran
                                        LABORALISTAS, digna rama del derecho en la Argentina, integrada por hombres
                                        y mujeres que en su gran mayoría patrocinan laburantes explotados, no
                                        inscriptos, mal pagos, que trabajan largas jornadas sin horas extras, y que
                                        son despedidos sin indemnización, sin pagos de aportes jubilatorios. Con la
                                        ayuda de esa ley que los protege esos trabajadores del derecho logran en
                                        muchos casos compensar en algo el abuso de empresarios, que solo quieren
                                        engrosar sus arcas sin importarles el destino de la sociedad en su conjunto.

                                    </p>
                                    <br>
                                    <p>Días después de una de las acciones que permitió a la dictadura barrer una
                                        serie de artículos importantes de la ley, intentando disciplinar al estilo
                                        VIDELA- MARTINEZ DE HOZ las relaciones laborales, también terminaron con la
                                        vida de CARLOS ALBERTO MORENO patrocinante de la ASOCIACIÓN OBRERA MINERA
                                        ARGENTINA en las causas contra la Cementera LOMA NEGRA de AMALIA LACROZE DE
                                        FORTABAT cuya empresa no garantizaba los elementos de seguridad y sus
                                        trabajadores terminaban postrados con sus pulmones terminados convertidos en
                                        piedra. La cementera logró ganancias extraordinarias al ahorrarse el pago de
                                        indemnizaciones laborales tras la desaparición de MORENO en abril del 77.
                                    </p>
                                    <figure>
                                        <img class=" w-full object-cover"
                                            src="{{ asset('img/der/izquier-3_der_corbatas_1.svg') }}" alt="">
                                    </figure>
                                    <br>
                                    <p>La lucha del pueblo, más las atrocidades de la Dictadura como la Guerra de
                                        Malvinas, produjo el retorno de la Democracia y con esta la recomposición y
                                        defensa de la legislación laboral, más allá del flagelo que significa el
                                        trabajo en negro que aún no podemos desterrar.
                                    </p>
                                    <br>
                                    <p>A NOCHE DE LAS CORBATAS, es un claro ejemplo de lo importante que significan
                                        las BUENAS LEYES PARA EL PUEBLO, tanto que las patronales asociadas a los
                                        militares asesinos de esa época intentaron eliminarlas.
                                    </p>
                                    <br>
                                    <p>oy, la derecha por otros medios (por ahora) intenta lo mismo, cercenar los
                                        derechos de los trabajadores, con excusas sin fundamento de distintas
                                        argumentaciones, pero con EL EJÉRCITO DE MEDIOS CONCENTRADOS DETRÁS, Y UN
                                        GRUPO DE ABOGADOS DE LOS GRANDES ESTUDIOS DE ARGENTNA, que representan
                                        legalmente a las patronales ricas de este país.
                                        Por todo lo expuesto vaya un PRESENTE HASTA LA VICTORIA SIEMPRE para quienes
                                        sin pertenecer a fuerzas políticas organizadas, simplemente abogados
                                        apasionados y justos, que dieron su vida por defender DERECHOS DE LOS
                                        TRABAJADORES, que hoy se ven más amenazados que nunca por los herederos
                                        legítimos de aquellos dictadores, LARRETA Y BULLRICH que no saben más que
                                        promocionar como la mejor medida de gobierno la esclavitud. Macri comenzó a
                                        desandar esta política con la sanción de la ley 27.348 y el intento
                                        permanente de flexibilizar las normas laborales
                                    </p>
                                    <br>
                                    <p>En el año 2014 el Parlamento argentino sancionó la ley 27715 en homenaje a
                                        aquellos que dieron sus vidas o sus libertades para defender a los
                                        trabajadores, que en su parte pertinente dice “Institúyase el día 7 de Julio
                                        como el día del Abogado Laboralista, en homenaje a los abogados Asesinados
                                        en lo que se conoció como “la noche de las corbatas” y de todos los letrados
                                        que, “por luchar por la democracia y la república sufrieron el mismo
                                        destino.”</p>
                                    <br>
                                    <p>La historia de estos mártires tiene muchas aristas desconocidas imposibles de
                                        relatar en una modesta nota, pero vale la intención de que no se pierda la
                                        MEMORIA, a la hora de decidir quién regirá en el futuro los destinos de la
                                        Patria.</p>
                                    <br>
                                    <figure>
                                        <img class=" w-full object-cover"
                                            src="{{ asset('img/der/izquier-3_der_corbatas_3.svg') }}" alt="">
                                    </figure>
                                    <br>
                                    <p>La corbata ya no se usa como antes en el ámbito tribunalicio, pero sigue
                                        siendo un símbolo de quienes defienden con pasión el derecho de los hombres
                                        y mujeres de este bendito suelo
                                    </p>
                                    <br>
                                </div>
                            ...
                            <div class="text-start object-center">
                                <figure>
                                    <img class="w-28 h-28  " src="{{ asset('../img/pol/edugarcia.svg') }}"
                                        alt="">
                                    <p> <strong>Nota de EDUARDO GARCÍA.<strong></p></a>
            ...
            <ul>
                <li class=" bg-white rounded-lg shadow ">
                    <article>
                        ...
                        <div class="py-4 px-4 justify-between items-center">
                            <h2 class="text-xl font-serif  font-bold pb-6">
                                <a href="">Los siniestros vuelos de la muerte</a>
                            </h2>
                            <p>Fue repatriado uno de los aviones utilizados para los vuelos de la muerte. Desde allí
                                fueron arrojadas al mar en 1977 tres fundadoras de las Madres de Plaza de Mayo
                                y dos monjas francesas. </p>
                            <br>

                            <figure>
                                <img class=" w-full object-cover" src="{{ asset('../img/der/der_vuelos.svg') }}"
                                    alt="">

                            </figure>
                            <p>Foto: Jorge Quaglini </p>
                            <br>
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 shrink-0 ">
                                <div class=" font-sans text-lg text-left col-span-6  ">
                                    <p>El avión Skyvan PA-51 de la Prefectura Argentina, utilizado durante la dictadura
                                        cívico militar eclesial en los vuelos de la muerte, será exhibido en el museo
                                        Sitio Memoria Ex Esma, como testimonio histórico de la memoria reciente. Esta
                                        aeronave fue utilizada como dispositivo de desaparición y muerte desde donde los
                                        secuestrados, detenidos-desaparecidos, eran arrojados vivos al mar.</p>
                                    <br>


                                    <p>Mientras los familiares de los militantes desaparecidos buscaban saber dónde
                                        estaban, qué había ocurrido con ellos, interponiendo recursos de hábeas corpus,
                                        investigando cada pista, la iglesia Santa Cruz, de la Ciudad de Buenos Aires,
                                        abría sus puertas para que pudieran reunirse en la parroquia. En esos encuentros
                                        se planificaban estrategias de búsqueda, se recaudaba dinero para solicitadas en
                                        los medios que estuvieran dispuestos de publicarlas y se diagramaban caminos
                                        para continuar con las averiguaciones. Estas reuniones fueron infiltradas por
                                        los servicios de inteligencia de la marina, con Alfredo Astiz para realizar
                                        operaciones ilegales encubiertas.
                                    </p>
                                    <br>


                                    <p>Entre el 8 y el 10 de diciembre de 1977, el GT 3.3.2. -temible grupo de tareas de
                                        la marina- secuestró y detuvo en forma clandestina a Azucena Villaflor de De
                                        Vicenti, Esther Ballestrino de Careaga, María Ponce de Bianco -las tres
                                        fundadoras de Madres de Plaza de Mayo-, las monjas francesas Alice Domon y
                                        Léonie Duquet, y los familiares Ángela Auad, Remo Berardo, Horacio Elbert, José
                                        Julio Fondevilla, Eduardo Gabriel Horane, Raquel Bulit y Patricia Oviedo.
                                    </p>
                                    <br>

                                    <p>Los secuestrados fueron llevados a la ESMA, donde fueron torturados, como
                                        relataron los sobrevivientes. El 14 de diciembre de 1977 los doce de la Santa
                                        Cruz fueron sedados y arrojados vivos desde el Skyvan en un vuelo de la muerte.
                                        Sin embargo, cinco de los cuerpos aparecieron en la costa atlántica, y fueron
                                        enterrados como NN en el cementerio de Gral. Lavalle, provincia de Buenos Aires.
                                        Esto permitió que en 2005, casi 30 años después, fueran identificados por el
                                        Equipo Argentino de Antropología Forense (EAAF). </p>
                                    <br>

                                    <p>Resultante de la investigación de Miriam Lewin, periodista y sobreviviente de la
                                        Escuela de Mecánica de la Armada y del fotógrafo italiano Giancarlo Ceraudo, uno
                                        de los aviones utilizados para asesinar a los cautivos pudo ser repatriado desde
                                        los EEUU , y ahora emplazado en el Museo Sitio Memoria ExEsma. Este hallazgo fue
                                        un superlativo aporte a la verdad, y clave para que la justicia argentina
                                        reconociera, por primera vez, el sistema implementado en los vuelos de la
                                        muerte. Por estos hechos a partir de la plantilla de vuelo y la identificación
                                        de los restos en 2017, el Tribunal Oral Federal 5 (TOF 5) condenó a prisión
                                        perpetua en la causa “ESMA Unificada” a los pilotos Mario Arru y Alejandro
                                        D’Agostino . El otro acusado, Enrique José Saint Georges, había muerto poco
                                        tiempo atrás. Todos ellos ex miembros de la División de Aviación de Prefectura.
                                    </p>
                                    <br>

                                    <p>El Skyvan, apodado "Caja de zapatos voladora", es un monoplano bimotor
                                        completamente metálico con un plano de cola montado en la mitad y timones
                                        gemelos. El primer vuelo de la aeronave construida por Short Brothers fue el 17
                                        de enero de 1963. Tiene una capacidad para 19 pasajeros y dos tripulantes. </p>
                                    <br>

                                    <p>El avión de fabricación inglesa, fue adquirido por Prefectura en 1971 y cuenta
                                        con características particulares que le permite despegar y aterrizar en pistas
                                        cortas y terrenos irregulares. La Prefectura Naval había operado con cinco
                                        Skyvans, dos de los cuales habían sido derribados durante la Guerra de las
                                        Malvinas. Uno había sido vendido a una empresa en Luxemburgo, otro a una empresa
                                        que prestaba servicios a las fuerzas armadas del Reino Unido y el tercero estaba
                                        en Estados Unidos, en Fort Lauderdale, todavía empleado en el servicio
                                        aeropostal con las Bahamas. </p>
                                    <br>

                                    <p>A más de cuatro décadas de estas brutales prácticas, uno de los aviones pudo ser
                                        adquirido y repatriado desde Fort Lauderdale, gracias a la militancia de los
                                        organismos de derechos humanos, con la intervención de los Ministerios de
                                        Defensa y Economía y la Secretaría de Derechos Humanos de la Nación.</p>
                                    <br>

                                    <p>Este símbolo como acto reparatorio y recordatorio de lo siniestro, de la crueldad
                                        y la deshumanización, sirva como refuerzo al ejercicio de la Memoria, la
                                        búsqueda de la Verdad, la profundización de la Justicia y la defensa de la
                                        Democracia.</p>
                                    <br>
                                    <br>
        ...
        <section>
            <ul>
                <li class=" bg-white rounded-lg shadow ">
                    <article>
                        <figure>
                            <img class=" w-full object-cover" src="../img/DDHH-7.svg" alt="">
                        </figure>
                        <div class="py-4 px-4 justify-between items-center">
                            <h2 class="text-xl font-serif  font-bold pb-6">
                                <a href="">La Secretaría relanza su web sobre juicios de lesa humanidad con la
                                    información de todas las causas que tuvieron sentencia desde 1985</a>
                            </h2>
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 shrink-0 ">
                                <div class=" font-sans text-lg text-left col-span-6  ">
                                    <p>Por primera vez, una web del Estado argentino reúne la información de los más de
                                        300 juicios por crímenes de lesa humanidad cometidos durante la dictadura
                                        cívico-militar (1976-1983) que tuvieron sentencia. Estos datos se suman al
                                        seguimiento en vivo de los debates que el sitio ya ofrecía.</p> <br>
                                    <p>En 2021 el Estado Nacional creó Juicios de lesa humanidad en tiempo real, una
                                        herramienta para contribuir a visibilizar, comunicar e impulsar el proceso de
                                        Memoria, Verdad y Justicia en Argentina. Hoy se relanza con la información de
                                        cada una de las causas que llegaron a sentencia y con nuevas herramientas de
                                        búsqueda de datos sobre juicios y condenados, audiencias pasadas y futuras y una
                                        línea de tiempo que contextualiza cada etapa. Además, ofrece estadísticas e
                                        historias contadas en microrrelatos audiovisuales ilustrados por artistas
                                        convocados especialmente para este proyecto.</p> <br>
                                    <p>Los juicios están vivos y tienen historia. Ahora están disponibles las fichas de
                                        los <strong> 319 juicios con sentencia </strong>; desde el histórico Juicio a
                                        las Juntas Militares de 1985 hasta Palazzesi de Córdoba, el segundo de 2023. En
                                        total fueron condenadas<strong> 1146 personas</strong> y hubo<strong> 253
                                            absoluciones</strong> en casi todo el país (salvo Santa Cruz y Tierra del
                                        Fuego).</p> <br>
                                    <p>Las causas avanzan, pero el tiempo se acaba. Hoy se desarrollan<strong> 14
                                            debates orales en 7 provincias</strong>. De las<strong> 240 imputadas e
                                            imputados</strong> que fueron elevados a juicio,<strong> 185 siguen en
                                            debate</strong>. El resto<strong> fallecieron (37)</strong> o fueron<strong>
                                            apartados por incapacidad (18)</strong> y no serán juzgados por los crímenes
                                        de los que se los acusa.</p>
                                    <p>Este relanzamiento es la conclusión de la segunda etapa de un trabajo comenzado
                                        en septiembre de 2020, cuando la Secretaría comenzó a sistematizar información
                                        para construir una primera base de datos unificada sobre los juicios de lesa
                                        humanidad. En 2021 se lanzó la primera versión de la web con los juicios en
                                        debate. El objetivo final es poner en línea la totalidad de los juicios
                                        actuales, próximos y pasados.</p>
                                    <p>Esta herramienta de transmisión de un proceso tan largo y complejo fue pensada a
                                        partir de un cruce entre datos, arte y memoria. Para poner a disposición pública
                                        esta información se hizo un trabajo mancomunado entre periodistas, abogados,
                                        investigadores, fiscales, docentes, visualizadores de datos, programadores,
                                        archivistas, ilustradores y artistas.</p>
                                    <br>
                                    <p>El sitio se nutre de bases de datos desarrolladas por distintas áreas de la
                                        Secretaría de Derechos Humanos (querellante en gran cantidad de causas) como la
                                        Dirección Nacional de Coordinación Estratégica, la Dirección Nacional de Asuntos
                                        Jurídicos Nacionales en materia de Derechos Humanos, la Delegación de
                                        Informática y Gestión de la Información en Derechos Humanos, el Archivo Nacional
                                        de la Memoria y el Consejo Federal de Derechos Humanos. También se cotejaron las
                                        bases de datos del Ministerio Público Fiscal de la Nación, de las querellas,
                                        acompañamiento a las víctimas y organismos de derechos humanos. Así, la web
                                        reúne en un solo lugar la información -hasta ahora fragmentada- de los juicios.
                                    </p>
                                    <p>El sitio web cuenta, además, con la colaboración de distintos artistas que
                                        aportaron sus obras para ilustrar juicios y crear los<strong>
                                            Microrrelatos</strong> una de las secciones originales de la web. A partir
                                        de fragmentos de testimonios vertidos en las audiencias, un equipo
                                        interdisciplinario, en contacto con víctimas y abogados y abogadas, construyó
                                        relatos audiovisuales de breve duración, buscando por medio de la
                                        experimentación narrativa, nuevas formas de comunicar el avance de los juicios y
                                        el conocimiento que generan.</p> <br>

                                    <p><strong> Nuevas herramientas de búsqueda</strong></p>
                                    <br>
                                    <p>Una de las novedades de la web es el<strong> Mapa de juicios</strong> que da
                                        cuenta de la dimensión federal del proceso de Memoria, Verdad y Justicia.
                                        Haciendo click en cada provincia o en CABA se puede acceder al listado completo
                                        de los juicios con sentencia o en debate. Es una de las entradas a las fichas
                                        con información básica (jueces, fiscales, querellantes, condenados, absueltos y
                                        un breve resumen). Otra opción es la sección<strong> Lista de juicios</strong>
                                        que ofrece una tabla ordenable por cantidad de condenados, testigos o imputados
                                        en el caso de los debates orales abiertos o filtros por jurisdicción judicial.
                                    </p> <br>
                                    <p>La sección de<strong> Condenados</strong> es otra de las herramientas
                                        desarrolladas en esta segunda etapa. Desde allí se puede acceder a las fichas de
                                        las más de mil cien personas condenadas hasta hoy. Cada ficha tiene datos
                                        básicos sobre la fuerza a la que perteneció, una pequeña biografía y las
                                        condenas que recibió.</p>
                                    <p>Para entender los distintos avances y retrocesos en los juicios, el sitio
                                        desarrolló una<strong> línea de tiempo</strong> con hitos nacionales,
                                        internacionales y provinciales.</p>
                                    <p>Finalmente, se mantiene el seguimiento de los juicios abiertos. En la home se
                                        encuentra la agenda de las audiencias con links a las transmisiones en vivo y
                                        herramientas estadísticas como el monitor de velocidad para medir el tiempo que
                                        demoran en llegar a sentencia. Uno de los reclamos de los organismos de derechos
                                        humanos y los querellantes, entre ellas la Secretaría de Derechos Humanos de la
                                        Nación, es el tiempo que tardan las causas, por lo que muchos imputados y
                                        víctimas fallecen antes de la lectura del veredicto. Por este motivo, la SDH
                                        pensó esta herramienta para visualizar los juicios de lesa.</p>
                                    <br>
        ...
        <section>
            <ul>
                <li class=" bg-white rounded-lg shadow ">
                    <article>
                        <figure>
                            <img class=" w-full object-cover" src="../img/DDHH-V.svg" alt="">

                        </figure>
                        <div class="py-4 px-4 justify-between items-center">
                            <h2 class="text-xl font-serif  font-bold pb-6">
                                <a href="">80 Años del levantamiento del Gueto de Varsovia</a>
                            </h2>
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 shrink-0 ">
                                <div class=" font-sans text-lg text-left col-span-6  ">
                                    <p>El 19 de abril de 1943, comenzó el levantamiento del gueto de Varsovia. Después
                                        de
                                        las deportaciones masivas a Treblinka en el verano de 1942, l@s judí@s del gueto
                                        de
                                        Varsovia se atrincheraron en búnkeres y se opusieron a la Aktion alemana de
                                        abril de
                                        1943. </p>
                                    <p>Después de un mes de resistencia valerosa, la rebelión fue aplastada y el gueto
                                        quemado hasta los cimientos. Se estima que alrededor de tres cuartos de los
                                        alrededor de las 40.000 personas judías que se hallaban en el gueto antes del
                                        levantamiento fueron deportadas a campos de exterminio.</p>
                                    <p>Unas 10.000 murieron durante la rebelión: en ejecuciones masivas y en los
                                        incendios.
                                        Ésta fue la primera rebelión popular realizada en un ámbito urbano en la Europa
                                        ocupada por los nazis. La rebelión del gueto de Varsovia sirvió de ejemplo para
                                        otros guetos y campos.</p>
        ...
        <section>
            <ul>
                <li class=" bg-white rounded-lg shadow ">
                    <article>
                        <figure>
                            <img class="h-100 w-full object-cover object-center" src="{{ asset('../img/DDHH-1.svg') }}"
                                alt="">

                        </figure>
                        <div class="py-4 px-4 justify-between items-center">
                            <h2 class="text-xl font-serif  font-bold pb-6">
                                <a href="">“Quien no dio todo, no dio nada”</a>
                            </h2>
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 shrink-0 ">
                                <div class=" font-sans text-lg text-left col-span-6  ">
                                    <p>Eso es lo que manifiesta una de las referentes de la medicina popular en la
                                        Argentina. Luchadora del campo social y de una noción sanitarista de la salud.
                                    </p>
                                    <p>Irma Laciar (1926/1976) dedicó su vida al cuidado de sus compañeros y la disputa
                                        por
                                        un mundo mejor.</p>
                                    <p>Irma nació en julio de 1926, en Sampacho, provincia de Córdoba. Se educó en una
                                        familia que influyó decididamente en su futuro, ya que su padre era un delegado
                                        ferroviario y sus dos tías eran enfermeras. Se involucró activamente en la
                                        militancia del campo popular desde la política y desde la salud.</p>
                                    <p>“La vida no es recompensa ni castigo, sino que es un desafío permanente”.</p>
                                    <p>“Hay un tiempo que será el tiempo de nuestra gente, de nuestro pueblo. Nosotros
                                        seguiremos adelante si respetamos el tiempo colectivo”, concluye.</p>
                                    <p>Carrica fue docente, en 1947, de los cursos de la Escuela de Enfermería que creó
                                        Ramón Carrillo; también ejerció la dirección de la Escuela de Auxiliares de
                                        Enfermería del Ministerio de Salud Pública de la Nación.</p>
                                    <p>Durante la década del 50 comenzó su actividad gremial en ATE, siendo delegada en
                                        sus
                                        lugares de trabajo. Participó como docente en las cátedras de medicina para el
                                        trabajo (1972-1973) e integró el equipo de Derechos Humanos de la CGT de los
                                        Argentinos.</p>
                                    <p>Durante el Gobierno de Isabel Perón fue despedida y comenzó a ser perseguida por
                                        la
                                        Triple A. Se ocupó de brindar apoyo a los familiares de los presos políticos y
                                        colaboró en la búsqueda de los desaparecidos, hasta que un grupo de tareas la
                                        secuestró en su departamento de Liniers el 18 de abril de 1977 y nunca más
                                        apareció.
                                    </p>
                                    <p>Sostenía que no había transformación posible si no construimos modelos
                                        diferentes,
                                        prácticas diferentes y hasta teorías diferentes”.</p>
                                    <p>En el año 1973 se realizó un congreso en la Facultad de Ciencias Médicas de la
                                        UBA
                                        que se llamó “Medicina para el trabajo y para los trabajadores”. Irma fue una de
                                        las
                                        que impulsó esa iniciativa y el resultado de ese encuentro fue un libro que
                                        publicó
                                        EUDEBA: Medicina del trabajo al servicio de los trabajadores”. Uno de los libros
                                        quemados por la dictadura públicamente.</p>
                                    <p>“La dictadura no podía soportar el cuestionamiento al poder de los sectores
                                        dominantes y un saber construido desde la inteligencia y la práctica de los
                                        trabajadores”</p>
                                    <p>El ímpetu, el coraje, el sentido humanitario y la consecuencia política
                                        ideológica de
                                        Carrica quedará en la memoria de quienes la conocieron y en el horizonte de los
                                        que
                                        van tomando contacto con su historia.</p>
        ...
        <section>
            <ul>
                <li class=" bg-white rounded-lg shadow ">
                    <article>
                        <figure>
                            <img class="h-100 w-full object-cover object-center" src="{{ asset('../img/DDHH-2.svg') }}"
                                alt="">

                        </figure>
                        <div class="py-4 px-4 justify-between items-center">
                            <h2 class="text-xl font-serif  font-bold pb-6">
                                <a href="">NIÑOS COMO VÍCTIMAS DE UN DOLOR SIN LÍMITES</a>
                            </h2>
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 shrink-0 ">
                                <div class=" font-sans text-lg text-left col-span-6  ">
                                    <p><strong> María, Carlos y Mariano Ramírez </strong> estuvieron alojados en el
                                        hogar
                                        Casa de Belén de Banfield, donde sufrieron todo tipo de violaciones y abusos.
                                    </p>
                                    <p>Hace 47 años el mundo era bien otro. Latinoamérica envuelta en procesos
                                        dictatoriales
                                        motorizados por la doctrina de la seguridad nacional, y en nuestro país de
                                        desataba
                                        la peor dictadura que recordemos, iniciada en 1976.</p>
                                    <p>Esta es una la historia del pasado que sigue siendo presente. Una de tantas.</p>
                                    <p>María Vicenta Orrego Meza de Ramírez, una joven paraguaya de 26 años conocida
                                        como
                                        CHELA, compartía la casa con sus tres hijos pequeños y dos compañeros de
                                        militancia.
                                        Después de la detención de su marido Julio Ramírez, vivía acosada y perseguida
                                        por
                                        la policía. </p>
                                    <p>Julio fue encarcelado en 1974, en pleno despliegue de la triple A, por su
                                        militancia
                                        en la JP y Montoneros. </p>
                                    <p>En la madrugada del 15 de marzo de 1977, un grupo de tareas entró a la casa de
                                        María
                                        Vicenta, en Rafael Calzada, partido de Almirante Brown y los arrancó de sus
                                        camas a
                                        ella y su tres hijos a los tiros . La patota era comandada por el jefe de la
                                        policía
                                        bonaerense Ramón Camps, genocida y Miguel Etchecolatz, director de
                                        investigaciones,
                                        genocida.</p>
                                    <p>Vicenta salió a la calle agitando un trapo blanco en señal de rendición. La
                                        acribillaron. Igual que a su compañera de militancia María Florencia Ruival y a
                                        José
                                        Luis Alvarenga, el otro compañero. La escena tuvo como testigos a tres niños,
                                        los
                                        hijos de Vicenta: Alejandro Mariano, María Ester y Carlos, de 2, 4 y 5 años.</p>
                                    <p>El caso de los hermanos Ramírez son eje del juicio de lesa humanidad llamado
                                        HOGAR
                                        CASA DE BELÉN.</p>
                                    <p>Luego de la balacera, los chiquitos quedaron abandonados en un baldío. Los
                                        rescató
                                        una vecina y luego quedaron a cargo de la jueza Marta Pons, de Lomas de Zamora.
                                        A
                                        los niños se les quitó el apellido y fueron designados como NN, manera corriente
                                        de
                                        nominar a los desaparecidos. </p>
                                    <p>Julio Ramírez, el padre, fue expulsado del país en 1981 y se exilió en Suecia.
                                        Allí
                                        comenzó un largo camino o calvario, para recuperar la tenencia de los hijos. El
                                        juzgado, sistemáticamente rechazó sus demandas de tenencia, en base a informes
                                        psicológicos en los que se consideraba que los niños no debían ser entregados a
                                        la
                                        familia de origen por “subversivos”.</p>
                                    <p>Recién en 1983, y gracias al Centro de Estudios Legales y Sociales (CELS) que
                                        presidía Emilio Mignone en ese momento, Julio Ramírez , el padre, obtuvo un
                                        dictamen
                                        de la Corte Suprema de Justicia y logró sacar a sus hijos de la Argentina.</p>
                                    <p>Hasta aquí los hechos.</p>
                                    <p>El juicio HOGAR CASA BELÉN termina siendo un caso testigo de la conexión entre la
                                        policía, los militares, el Poder Ejecutivo, EL poder judicial y la Iglesia
                                        Católica.
                                        La acción en conjunto de las instituciones estatales en manos de la dictadura
                                        genocida se convierte en un proceso histórico, sentando precedente, en la
                                        complicidad , no solamente para apropiarse de niños nacidos en cautiverio,
                                        sustituyendo identidades , sino para separar a niños de sus familias y después
                                        criarlos en hogares eclesiásticos donde fueron víctimas de todo tipo de abusos.
                                    </p>
                                    <p>Este juicio dejó en claro que los niños y la niña Ramírez fueron confinados,
                                        encerrados, como prisioneros a disposición del Poder Judicial y ocultados hasta
                                        los
                                        finales de la dictadura. A pesar de conocer sus nombres y apellidos, de conocer
                                        sus
                                        identidades, fueron entregados como NN al HOGAR CASA BELÉN. Este hogar quedaba
                                        en
                                        Banfield, conurbano de la Pcia. De Buenos Aires y dependía de la parroquia
                                        Sagrada
                                        Familia de Nazareth. Allí fueron inscriptos con el apellido de los cuidadores de
                                        la
                                        institución, siguiendo un plan sistemático de borramiento de subjetividad.</p>
                                    <p>De acuerdo a la causa judicial, en el hogar de menores los hermanos Ramírez
                                        sufrieron
                                        tormentos y abusos sexuales reiterados. La jueza Pons a cargo del Tribunal de
                                        Menores de Lomas de Zamora impidió sistemáticamente que su padre y una tía
                                        paterna
                                        conocieran el paradero de los niños y, cuando al fin lo lograron, tampoco les
                                        permitió tomar contacto.</p>
                                    <p>Este juicio no es comparable con otras apropiaciones de menores, de niños nacidos
                                        en
                                        cuativerio porque estos chicos fueron encerrados en un hogar ligado a la
                                        Iglesia,
                                        que en vez de protegerlos, los maltrató, los escondió de su familia biológica y
                                        abusó de ellos cosificándolos, poniéndolos en el lugar de descartables, por ser
                                        hijos de militantes como por ser paraguayos. Doble Discriminación en un espacio
                                        similar a los campos de concentración.</p>
                                    <p>Desde que se reencontraron con su familia, a fines de diciembre de 1983, los
                                        hermanos
                                        Ramírez viven en Suecia con su padre, Julio. Durante más de una década, el
                                        juicio se
                                        suspendió tres veces y estuvo a punto de caerse. En ese tiempo la biología de
                                        los
                                        acusados jugó en contra: varios fallecieron, otros fueron apartado por
                                        incapacidad.
                                    </p>
                                    <p>Este juicio, que comenzó el 4 de marzo de 2022, en el Tribunal Oral Federal 1 de
                                        La
                                        Plata está en su último segmento. Además de solicitar penas a los acusados hay
                                        una
                                        solicitud de declaración de verdad para los hermanos Ramírez, y que el HOGAR
                                        CASA
                                        BELËN sea señalizado para que funcione como sitio de memoria, que sea
                                        desafectado
                                        como Hogar y los niños y niñas internos sean reubicados. </p>
                                    <p>Los acusados son Jaime Smart, que fuera ministro de Gobierno de la provincia de
                                        BsAs
                                        , Juan Miguel Wolk, excomisario y jefe del Pozo de Banfield, y los expolicías
                                        bonaerenses que revistaban en la Brigada de Investigaciones de Lanús Roberto
                                        Guillermo Catinari, Héctor Raúl Francescangeli, Armando Antonio Calabró, Rubén
                                        Carlos Chávez y José Augusto López, expolicía de la misma brigada, además de la
                                        exsecretaria del Tribunal de Menores N°1 de Lomas de Zamora Nora Susana
                                        Pellicer.
                                    </p>
                                    <p>Miguel Etchecolatz estaba imputado pero quedó impune por fallecimiento en prisión
                                        el
                                        2 de julio de 2022, a los 93 años. </p>
                                    <p>Un asterisco sobre Marta Delia Pons, la jueza que tuvo una activa participación
                                        en la
                                        apropiación de niños nacidos en cautiverio o secuestrados junto a sus padres
                                        durante
                                        la dictadura murió impune en 1999. Nunca fue imputada en la investigación por el
                                        Plan Sistemático de robo de bebés.</p>
                                    <p>Siempre nombramos la tragedia de la dictadura como cívico militar y eclesiástica.
                                        Ese
                                        costado de complicidades que participaron del Terrorismo de Estado, como una
                                        deuda
                                        pendiente de los procesos de lesa humanidad en nuestro país, modelo en el mundo
                                        en
                                        los juzgamientos por los delitos más aberrantes de ese tramo de historia
                                        reciente,
                                        cuando la vida tenía el valor de la nada misma. </p>
        ...
        <section>
            <ul>
                <li class=" bg-white rounded-lg shadow ">
                    <article>
                        <figure>
                            <img class=" w-full object-cover" src="{{ asset('img/LOS POZOZ.svg') }}" alt="">
                        </figure>
                        <div class="py-4 px-4 justify-between items-center">
                            <h2 class="text-xl font-serif  font-bold pb-6">
                                <a href="">EN EL MES DE LA MEMORIA LOS POZOS SE DESTAPAN</a>
                            </h2>
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 shrink-0 ">
                                <div class=" font-sans text-lg text-left col-span-6  ">
                                    <p>Lo que se conoce como El Pozo de Vargas ubicado a muy pocos kilómetros del centro
                                        de
                                        San Miguel de Tucumán , es una construcción subterránea de mampostería de fines
                                        del
                                        siglo XIX que fue utilizado por la última dictadura militar entre 1976 y 1977
                                        como
                                        sitio de inhumación clandestina.</p>
                                    <p>Cuando uno piensa en un pozo, esto remite al vacío, a la nada. </p>
                                    <p>El Pozo de Vargas fue un pozo de agua diseñado por los ingleses. Se pensó como un
                                        como parte del trazado ferroviario para abastecer de agua a las viejas
                                        locomotoras a
                                        carbón.</p>
                                    <p>Recién en 2001, la Justicia llegó a la zona gracias a una serie de testimonios y
                                        denuncias que hablaban de un hoyo en la tierra que se tragaba a los
                                        desaparecidos.
                                    </p>
                                    <p>Como una garganta de 3 metros de diámetro y más de 40 metros de profundidad , en
                                        pleno corazón de Tucumán, convertida en una boca gigante que se tragaba a las
                                        víctimas que la última dictadura cívico-militar-eclesial hacía desaparecer. Toda
                                        una
                                        metáfora del horror.</p>
                                    <p>En abril de este año su cumplirán 21 años del inicio de las excavaciones, una de
                                        las
                                        fosas más grandes de Latinoamérica, sino la más grande.</p>
                                    <p>Como inicio de esta historia tenemos que recordar la puesta en marcha del
                                        Operativo
                                        Independencia, justo un año antes del golpe de Estado del 24 de marzo de 1976.
                                        Fue
                                        un laboratorio, donde el Gral. De brigada Acdel Vilas, primero y luego Antonio
                                        Bussi, General de la Nación, aplicaron las modalidades más terribles de
                                        secuestro,
                                        experimentación de torturas, violaciones masivas, desaparición y sistemático
                                        desconocimiento de los ddhh.</p>
                                    <p>Gran paradoja: Bussi llegó a ser Gobernador de la Provincia de Tucumán
                                        (1995–1999)
                                        durante el menemato.</p>
                                    <p>Pero….la memoria y la oralidad de los relatos los vecinos de la zona convertidos
                                        en
                                        claves para la apertura de una investigación judicial el 28 de febrero de 2002,
                                        a la
                                        que se suman 7 querellantes familiares, permiten que comience a caer la cortina
                                        del
                                        silencio. Esto, muchos años después del regreso de la democracia. </p>
                                    <p>El Juez Terán del Juzgado federal nº 2 (fallecido ya), logra ingresan al terreno
                                        junto a un grupo interdisciplinario de arqueólogos y antropólogos de la
                                        UNTucumán.
                                    </p>
                                    <p>Esos inicios no fueron fáciles. La boca del pozo fue tapada por cientos de
                                        toneladas
                                        de material. Tardaron dos años en hallar los primeros restos. Desde entonces los
                                        antropólogos tucumanos comenzaron a trabajar junto al EAAF (Equipo Argentino de
                                        Antropología Forense). </p>
                                    <p>El Pozo en la actualidad está en medio de la urbanización: en el acceso principal
                                        del
                                        barrio LOMAS DE TAFí, donde viven 30.ooo tucumanos.</p>
                                    <p>Ese primer paso se dio en 2015 por la Sec de ddhh de la nación, con la
                                        señalización
                                        como SITIO DE MEMORIA.</p>
                                    <p>A partir del año siguiente y con la nueva de admiración gubernamental, se pararon
                                        los
                                        presupuestos y se desfinanció la tarea. Se detuvieron las investigaciones en
                                        pleno
                                        gobierno de Cambiemos , donde la memoria era solamente una página para dar
                                        vuelta y
                                        lo pasado pisado.</p>
                                    <p>Con el nuevo gobierno asumido en 2019 , se retomaron las obras, con mucha
                                        lentitud,
                                        pandemia mediante. Intervino directamente la sec de ddhh de la Nación y la
                                        situación
                                        comenzó a normalizarse. Los trabajos que restaban eran a un nivel tan
                                        subterráneo,
                                        ya que demandaban equipamiento de oxígeno y la intervención de especialistas,
                                        por la
                                        presencia de napas de agua.</p>
                                    <p>Hoy hay identificados 116 vícitmas de los restos óseos de 149 personas.</p>
                                    <p>Del total de víctimas cuyos restos se encontraron en el pozo, un importante
                                        número
                                        provenía del centro clandestino que funcionó en la compañía Arsenales, de
                                        Tucumán.
                                        Dentro de ese grupo había personas del mundo azucarero, obreros del surco,
                                        obreros
                                        de los talleres de Tafí Viejo, ferroviarios, militantes políticos y sociales,
                                        estudiantes, docentes y egresados de la UN de Tucumán.</p>
                                    <p>ADN POPULAR , nuestro programa y los que componemos este equipo de periodistas,
                                        jamás
                                        pisamos lo pasado. Porque sigue siendo un doloroso presente aquel que se oculta,
                                        aquel que se calla , aquel que se borra.</p>
                                    <p></p>
        ...
        <section>
            <ul>
                <li class=" bg-white rounded-lg shadow "> {{-- primera --}}
                    <article>
                        <figure>
                            <img class=" w-full object-cover" src="{{ asset('img/BLAQUIER.svg') }}" alt="">
                        </figure>
                        <div class="py-4 px-4 justify-between items-center">
                            <h2 class="text-xl font-serif  font-bold pb-6">
                                <a href="">BLAQUIER, EL QUE SE FUE SIN DESPEDIRSE</a>
                            </h2>
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 shrink-0 ">
                                <div class=" font-sans text-lg text-left col-span-6  ">
                                    <p>Y se murió nomás…en cama limpia, con cuidados atentos, y se llevó sus secretos
                                        llenos
                                        de impunidad. Venció una vez más la biología del final. </p>
                                    <p>A los 95 dejó la vida Carlos Blaquier, largo privilegio tuvo el anciano patrón.
                                        Que
                                        alguna vez fue joven, poderoso, parte del gran poder. El que tomaba decisiones y
                                        de
                                        las que nunca se retractaba. </p>
                                    <p>Este Doctor en derecho y con un título en Filosofía, fue algo más que un
                                        empresario
                                        comprometido con el terrorismo de Estado, fue uno de los civiles que le dieron
                                        carnadura al plan económico de la dictadura cívico militar eclesial, encabezado
                                        e
                                        ideado por quien fuera su ministro de Economía Martínez de Hoz.</p>
                                    <p>Tenía Blaquier abierta una causa por crímenes de lesa humanidad, por ser
                                        responsable
                                        de la detención de 400 personas en julio de 1976 de las cuales 55 siguen
                                        desaparecidas. Siempre con garantías de impunidad. Así es pertenecer a los
                                        rancios
                                        círculos de mando y poder.</p>
                                    <p>Ledesma la empresa que presidía, colaboró prestando sus camiones para la
                                        detención de
                                        personas durante los apagones eléctricos en Calilegua, El Talar y Libertador
                                        General
                                        San Martín en la provincia de Jujuy, durante los meses de junio y julio de 1976.
                                        La
                                        empresa Ledesma con su usina, abastecía de energía a esas localidades. De esa
                                        forma,
                                        quitando el suministro eléctrico, sembraba el terror y colaboraba con el
                                        accionar
                                        del ejército.</p>
                                    <p>El primer corte del suministro eléctrico se produjo el 20 de julio de 1976 a la
                                        medianoche en Libertador General San Martín y Calilegua. Según los testimonios
                                        de
                                        vecinos, testigos de los hechos, contaron que al momento del corte de luz se
                                        habían
                                        imaginado que se trataba de un corte común, para reparar alguna instalación
                                        eléctrica o producto de un desperfecto. Pero cuando la gente comenzó a escuchar
                                        ruidos de frenadas, y arranques de motores en huìda , puertas abiertas a patadas
                                        y
                                        gritos de la gente, se dieron cuenta que se estaba viviendo un episodio de
                                        represión
                                        y secuestro masivo. </p>
                                    <p>Esa noche la ciudad de Libertador General San Martín y la localidad de Calilegua
                                        fueron sitiadas por la Policía de la provincia de Jujuy, la Policía Federal, el
                                        Ejército y la Gendarmería Nacional y a las 10 de la noche, se produjo, en
                                        simultáneo, un apagón total (salvo en la fábrica de Ledesma).</p>
                                    <p>Los secuestrados, alrededor de 400, fueron llevados a centros clandestinos de
                                        detención en los galpones del ingenio Ledesma, donde permanecieron atados y
                                        encapuchados. </p>
                                    <p>La empresa agroindustrial Ledesma proveyó a los militares de personal y vehículos
                                        para la captura de personas. En coches eran trasladados los detenidos, quienes
                                        eran
                                        arrojados en comisarías a Guerrero, una ex Escuela de Policía utilizada como
                                        centro
                                        clandestino de detención en el plan sistemático de terror y exterminio, luego
                                        eran
                                        trasladados a Buenos Aires, principalmente.</p>
                                    <p>Demás está aclarar que en esa época el ingenio Ledesma era el encargado de la
                                        distribución de la electricidad. </p>
                                    <p>Aunque en el Gran Norte, en Jujuy, salta, Tucumán, Catamarca….todo había
                                        comenzado
                                        durante el “Operativo Independencia” en esa prueba piloto de 1975, cuando las
                                        fuerzas represivas desembarcan sobre el sindicato azucarero desarticulando su
                                        comisión directiva con los egresados de la Escuela de las Américas lugar de
                                        entrenamiento creado por el Ejército de los Estados Unidos en Panamá, fundada en
                                        1946 en con la finalidad de formar militares de América Latina y el Caribe
                                        siguiendo
                                        la doctrina de la seguridad nacional, cuyas tácticas militares incluían los
                                        métodos
                                        de contrainformación, interrogatorio (con métodos de tortura y ejecución
                                        sumaria),
                                        guerra psicológica, inteligencia militar y acción de contrainsurgencia. El
                                        manual de
                                        contrainteligencia de la escuela definía como enemigos a aquellos que
                                        “pertenecieran
                                        a organizaciones sindicales”, “distribuyeran propaganda a favor de los
                                        trabajadores
                                        o de sus intereses”, “simpatizaran con manifestaciones o huelgas” o incluso
                                        hicieran
                                        “acusaciones sobre el fracaso del gobierno en solucionar las necesidades básicas
                                        del
                                        pueblo”. </p>
                                    <p>Y como todo tiene que ver con todo, Baquier muere en la impunidad como el
                                        resultado
                                        de la sociedad de los grandes empresarios y los gobiernos plutocráticos o
                                        estados
                                        terroristas que cuentan con gobiernos y el Estado de su lado. </p>
                                    <p>Un detalle revelador:</p>
                                    <p>Olga Arédez , aquella marchante solitaria de pañuelo blanco, que quedó sola
                                        cuando
                                        murieron sus compañeras dixit, textual : “ me entrevisté con el administrador
                                        del
                                        Ingenio Ledesma, el ingeniero Alberto Lemos. Él admitió que la Empresa había
                                        puesto
                                        sus móviles a disposición de la acción conjunta llevada a cabo por las fuerzas
                                        armadas, en sus palabras, "para limpiar al país de indeseables". También aseguró
                                        que
                                        mi esposo, debido a su actividad como asesor médico de los obreros, había
                                        resultado
                                        muy perjudicial para los intereses económicos de la empresa Ledesma.”</p>
                                    <p>Olga Arédez , aquella marchante solitaria de pañuelo blanco, que quedó sola
                                        cuando
                                        murieron sus compañeras dixit, textual : “ me entrevisté con el administrador
                                        del
        ...
        <section>
            <ul>
                <li class=" bg-white rounded-lg shadow "> {{-- primera --}}
                    <article>
                        <figure>
                            <img class=" w-full object-cover" src="{{ asset('img/SI _HAY _MI.svg') }}"
                                alt="">
                        </figure>
                        <div class="py-4 px-4 justify-between items-center">
                            <h2 class="text-xl font-serif  font-bold pb-6">
                                <a href="">LOS FEOS, LOS SUCIOS Y LOS DISCAPACITADOS BAJO LA ALFOMBRA DE LA
                                    DESMEMORIA.</a>
                            </h2>
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 shrink-0 ">
                                <div class=" font-sans text-lg text-left col-span-6  ">
                                    <p><strong>“Catamarca se ha convertido en refugio de desposeídos”</strong>, tituló
                                        El
                                        ...
                                        tiempos de los 70`s.</p>
                                    <p>Vera, colega del interior, del gran norte, logró que el Diario La Unión de
                                        Catamarca
                                        publicara en tapa, un episodio que hubiera quedado en la oscuridad del olvido.
                                    </p>
                                    <p>En la madrugada del 17 de julio de 1977, en plena ferocidad de la dictadura
                                        cívico,
                                        ...
                                        Catamarca , para mejorar el paisaje. Los mandaron a morir.</p>
                                    <p>Algunos ciegos, otros discapacitados motrices, varios con discapacidades
                                        mentales,
                                        ...
                                        diferente.</p>
                                    <p>La cacería duró tres días. Fue una siembra humana de vagabundos en zonas
                                        inhóspitas y
                                        heladas, entre el Bañado de Ovanta y la Cuesta del Totoral.</p>
                                    <p>Sólo un psicópata , característica central de los que decidían quién vivía y
                                        quién
                                        moría, pensó que la deportación de los miserables iba a disimular la pobreza de
                                        una
                                        provincia bajo fuego.</p>
                                    <p>Cinco policías, dos de civil y tres de uniforme, se encargaron de cumplir las
                                        órdenes
                                        ...
                                        los
                                        mendigos de Bussi.</p>
                                    <p>Esto ocurrió poco antes de una visita protocolar a Tucumán del presidente de
                                        facto,
                                        ...
                                        los
                                        cuarteles.</p>
                                    <p>El gobernador militar tucumano Bussi, de quien ya habíamos hablado la semana
                                        pasada,
                                        ...
                                        convertido en alguien que sobra.</p>
                                    <p>Casi 30 años después (2004) el Gran escritor tucumano, Tomás Eloy Martínez, autor
                                        de
                                        ...
                                        paraíso terrestre”.</p>
                                    <p>Antonio Bussi inició una demanda por calumnias e injurias contra el autor de la
                                        nota
                                        ...
                                        frontera. </p>
                                    <p>Durante el juicio, Bussi dijo textualmente que “estas personas alteraban el orden
                                        con
                                        sus cacharros, sus muñones y su mugre, golpeando tachos, molestaban a las
                                        mujeres. Y
                                        en un momento un policía en un exceso de celo actuó y los limpió”.</p>
                                    <p>En su crónica, Tomás Eloy Martínez apuntó a Bussi como responsable mayor de
                                        aquella
                                        ...
                                        de
                                        una culpa que, según él, era de sus subordinados”.</p>
                                    <p>En el juicio por calumnias e injurias, la Justicia falló en contra del gobernador
                                        genocida. Sin embargo, el militar retirado nunca pagó las costas del proceso
                                        penal.
                                    </p>
                                    <p>Pasaron los años hasta que, el 28 de agosto de 2008, el propio Bussi fue
                                        enjuiciado y
                                        condenado por crímenes de lesa humanidad.</p>
                                    <p>ADN Popular les devuelve el nombre , el apodo como eran conocidas las víctimas:
                                        ...
                                        palabras cuando las palabras eran riesgo de vida.</p>
                                    <p>Hay espejos en los que no queremos reflejarnos, hay nostálgicos que sueñan con
                                        sobras
                                        ...
                                        detentan el poder real.</p>
                                    <p>Nosotres, les laburantes, los desocupados, las enfermas, los altos, las bajas,
                                        los
                                        flacos, las gordas, los y las trans, las diversidades, no sobramos. </p>
                                    <p>Y como todo tiene que ver con todo… que ese todo trágico y despótico no vuelva
                                        ….NUNCA MÁS.</p>
