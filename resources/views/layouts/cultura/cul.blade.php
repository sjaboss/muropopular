                                ...
                                <div class="py-4 px-4 justify-between items-center">
                                    ...
                                    <div
                                        ...
                                        <div class=" font-sans text-lg text-left col-span-6  ">
                                            ...
                                            <br>
                                            <p>La exposición<strong> "Nuestra urgencia x vencer. Fotografías de la lucha de
                                                mujeres contra la dictadura"</strong> busca dar a conocer un importante
                                                archivo fotográfico inédito y recientemente documentado, realizado
                                                durante la década de los 80 por la reportera gráfica<strong> Kena Lorenzini</strong>,
                        ...
                        <div
                            ...
                            <div class=" font-sans text-lg text-left col-span-6  ">
                                ...
                                <figure>
                                    <a href="">
                                        <img class="h-80 w-full object-cover object-center"
                                            src="{{ asset('../img/cul/cul_sosa2.svg') }}" alt="">
                                    </a>
                                </figure>
                                <br>
                                ...
                                <figure>
                                    <a href="">
                                        <img class="h-80 w-full object-cover object-center"
                                            src="{{ asset('../img/cul/cul_sosa1.svg') }}" alt="">
                                    </a>
                                </figure>
                                <br>
                        ...
                        <div
                            ...
                            <div class=" font-sans text-lg text-left col-span-6  ">
                                ...
                                <div class="text-start object-center">
                                    <figure>
                                        <img class="w-28 h-28"
                                            src="{{ asset('../img/noteros/julito.svg') }}" alt="">
        ...
        <section>
            <ul>
                <li class=" bg-white rounded-lg shadow "> {{-- primera --}}
                    <article>
                        <figure>
                            <img class="w-full object-cover object-center" src="{{ asset('../img/C-3.svg') }}"
                                alt="">
                        </figure>
                        <div class="py-4 px-4 justify-between items-center">
                            <h2 class="text-xl font-serif  font-bold pb-6">
                                <a href=""> EL FIN DEL MAL, EL COMIENZO DEL MAL</a>
                            </h2>
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 shrink-0 ">
                                   <div class="font-sans text-lg text-center col-span-6">
                                    <p><strong> Una historia pospandémica</strong>. Por José Pablo Feinmann </p>
                                    <p>No murieron todos. Algunos quedaron vivos, se salvaron de la pandemia
                                        depredadora. Eran pocos. Se juntaron en unas tierras verdes de Irlanda y
                                        Escocia. Pronto todos hablaron un mismo idioma. Pronto empezaron a trabajar la
                                        tierra y a vivir de la abundancia de esos suelos.</p>
                                    <p>Parecía, sin embargo, que habían adquirido una nueva enfermedad. Eran buenos.
                                        Eran solidarios unos con otros. Eran generosos. Nadie le pegaba a una mujer.
                                        Nadie se embriagaba. Nadie fundó un banco. La utopía de algunos sobre la
                                        humanidad de la pospandemia se había cumplido. Era una nueva humanidad. Había
                                        aprendido la lección de la muerte. Había que vivir en paz junto a los otros.
                                        Nadie mató a nadie.</p>
                                    <p>Uno de ellos había manejado una financiera. Atrás, en el pasado, antes de la
                                        pandemia purificadora. Ahora tenía una chacra que cultivaba laboriosamente. Le
                                        gustó su chacra. El pasto crecía más verde. Los árboles más altos y fuertes.
                                        Siempre la acariciaba el sol. Era la mejor chacra del nuevo mundo. Entonces
                                        decidió alambrarla. Puso unos alambres con unas púas feroces. Llamó a los demás,
                                        a todos los otros, se paró sobre una silla y dijo, señalando su chacra dijo:
                                        “Esto es mío. Solamente mío. No es ni será de nadie más”.</p>
                                    <p>Ese día, una vez más, el Mal volvió a adueñarse de la tierra. </p>
                                    <p>ADN Populares homenajea con este texto a Juan Pablo Feimann (1943-2021), filósofo
                                        , pensador, docente y quien siempre nos ayudaba a pensar mejor y más
                                        profundamente. Te extrañamos Juan Pablo.</p>
        ...
        <section>
            <ul>
                <li class=" bg-white rounded-lg shadow "> {{-- primera --}}
                    <article>
                        <figure>
                            <img class="w-full object-cover object-center" src="{{ asset('../img/C-4.svg') }}"
                                alt="">
                        </figure>
                        <div class="py-4 px-4 justify-between items-center">
                            <h2 class="text-xl font-serif  font-bold pb-6">
                                <a href=""> LOS REYES MALOS de JUAN JOSÉ PANNO</a>
                                <br>
                                <a href="">Cuento para niñeses</a>
                            </h2>
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 shrink-0 ">
                                <div class=" font-sans text-lg text-left col-span-6  ">
                                    <p>Labuelo, me contás un cuento?</p>
                                    <p>Labuelo me dice , como cuando era chiquita y escuchaba que iba a la casa
                                        “delabuelo” y le quedó: casa de “labuelo”. Ahora… de vez en cuando, se hace la
                                        graciosa….. sobre todo cuando pide algo tiernamente y me llama así.</p>
                                    <p>¿Un cuento?!!!!!! …….. Ahora? …..Esperá que busco un librito del Pajarito
                                        Remendado.</p>
                                    <p>-No, uno tuyo, inventado.</p>
                                    <p>Entonces invento. </p>
                                    <p>Hay veces que las palabras que se parecen…. producen grandes confusiones: gata y
                                        rata se parecen como coco y loco , nono y mono y así podríamos dar un montón de
                                        ejemplos.</p>
                                    <p>Una confusión que fue muy grande se produjo con una palabra …. en un pueblo de
                                        Centroamérica. </p>
                                    <p>Los Reyes Malos llamaban a Melchor, Gaspar y Baltasar durante años….. Creían que
                                        eran malísimos,…..que les robaban los juguetes a los pibes de todos los
                                        pueblos….. y por eso iban con esas bolsas cargadas. </p>
                                    <p>Pensaban que se iban a quedar con los chiches de los nenes y no los dejaban
                                        entrar.</p>
                                    <p>Los recibían con balines de aire comprimido…. que asustaban a los camellos.</p>
                                    <p>Los 5 de enero a la noche evitaban que llegaran…. los llamados Reyes Malos.</p>
                                    <p>¿Sabés como los llamaban a cada uno? </p>
                                    <p>-¿Cómo?</p>
                                    <p>- Malhechor, que es un sinónimo de delincuente ,….. Va a Asaltar ( o sea va a a
                                        robar) y Raspar.</p>
                                    <p>-Uhhh-Qué confusión, labuelo</p>
                                    <p>- Si, viste?!!!</p>
                                    <p>-¿Y entonces?</p>
                                    <p>-Y entonces…. un día el guardián de la puerta de entrada al pueblo…. se quedó
                                        dormido y los Reyes pudieron entrar.</p>
                                    <p>Les llamó la atención que no había zapatos,……Medio que se fastidiaron porque no
                                        les habían dejado pastito y agua a los camellos. ……..Dejaron regalitos y se
                                        fueron tan rápido como habían llegado.</p>
                                    <p>El 6 de enero de hace pocos años a la mañana……. los pibes encontraron pelotas,
                                        mecanos, muñecas, juegos de mesa y hasta una bici y un triciclo.</p>
                                    <p>Junto a cada regalo había una tarjetita: “ Los Reyes Magos”.</p>
                                    <p>Los pibes estaban fascinados…. y los adultos que leyeron la tarjetita
                                        comprendieron el equívoco;……. Eran magos, no malos, los Reyes Magos. </p>
                                    <p>Desde entonces…. cuando llegan al pueblo……. los pibes les dejan pastito y agua
                                        para los camellos. </p>
                                    <p>Los adultos les ponen medio litro de vino y un sanguche de jamón y queso.</p>
                                    <p>Las malas lenguas dicen que los sanguches son de jabón y hueso,…… porque en ese
                                        pueblo siempre se cnden.</p>
        ...
        <section>
            <ul>
                <li class=" bg-white rounded-lg shadow "> {{-- primera --}}
                    <article>
                        <figure>
                            <img class=" w-full object-cover object-center" src="{{ asset('../img/C-1.svg') }}"
                                alt="">
                        </figure>
                        <div class="py-4 px-4 justify-between items-center">
                            <h2 class="text-xl font-serif  font-bold pb-6">
                                <a href=""> Lali Espósito es nueva Personalidad Destacada de la Ciudad </a>
                            </h2>
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 shrink-0 ">
                                <div class=" font-sans text-lg text-left col-span-6  ">
                                    <p>La artista multifacética cuenta con cuatro discos de estudio y varios premios,
                                        además de ser una de las estrellas más renombradas del entretenimiento
                                        argentino.</p>
                                    <p>La cantante, compositora y actriz Mariana “Lali” Espósito fue declarada como
                                        Personalidad Destacada de la Cultura por parte del Cuerpo Legislativo de la
                                        Ciudad. El acto se llevó a cabo esta tarde, primeramente en el Salón Alfonsín,
                                        donde se realizó una conferencia de prensa junto a medios nacionales e
                                        internacionales. Luego, el acto formal se desarrolló en el Salón Dorado y contó
                                        con la presencia del Vicepresidente 1° de la Legislatura Emmanuel Ferrario, el
                                        legislador y autor del proyecto Matías López (VJ), el ministro de Cultura de la
                                        Ciudad de Buenos Aires Enrique Avogadro y la homenajeada. Además de varios
                                        famosos como Cris Morena, Adrián Suar y Soledad Pastorutti, que la saludaron a
                                        través de un video.</p>
                                    <p>En el inicio de las alocuciones, Ferrario “se enorgulleció” de darle la
                                        bienvenida a la Legislatura de la Ciudad a los presentes. “Hoy reconocemos a
                                        Lali por su esencia, su esfuerzo y su talento. Es impresionante lo que lograste
                                        en 20 años de carrera”, subrayó el vicepresidente. También destacó que la
                                        artista fue la primera artista femenina en llenar un estadio, por el reciente
                                        show en Vélez Sarsfield. “Este espacio es de todos los porteños y debemos
                                        destacar a todos aquellos que dejan una marca en la ciudad”, agregó.</p>
                                    <p>Por su parte, López recalcó que la distinción “es un reconocimiento a la pasión y
                                        a la determinación”. Y sumó: “Siempre te animas y te estás reinventando,
                                        buscando cómo generar lo que lograste en estos años. Todos creemos que sos
                                        esfuerzo, talento, pasión y Parque Patricios”.</p>
                                    <p>En tanto que Lali comentó: “Uno puede soñar con que le vaya bien en el trabajo,
                                        pero nunca puede imaginar sin querer representar a parte de la gente que
                                        admiro”, marcó Lali en el Salón Dorado y ante miles de fanáticos. En ese sentido
                                        puntualizó que su trabajo es emocionar y generar empatía con otro”.</p>
                                    <p>“En mi contexto soñar con algo tan enorme era imposible porque uno lo que tenía
                                        alrededor era gente que vivía de lo que podía y lo que tenía y no de lo que
                                        quería. Es un reconocimiento que ya me excede, es colectivo”, distinguió la
                                        cantautora. Y concluyó: “No hay talento que valga si no tenés gente amorosa
                                        alrededor. Hacia adelante todos aquellos que tengan sueños con el arte”.</p>
                                    <p>Lali Espósito es una de las estrellas más populares del entretenimiento hispano.
                                        Nació el 10 de octubre de 1991 en Parque Patricios y comenzó su carrera a los 10
                                        años. En sus inicios participó en exitosas series televisivas como “Rincón de
                                        Luz” y Floricienta”, mientras que en su adolescencia protagonizó la serie
                                        juvenil “Casi Ángeles” que dio origen al grupo musical “Teen Angels”, un
                                        cuarteto integrado por Lali, Pedro Lanzani, Nicolás Riera y Eugenia Suarez.
                                        “Teen Angels” editaron seis álbumes de estudio, tres álbumes en vivo y giraron
                                        por Argentina, Latinoamérica e Israel.</p>
                                    <p>En 2015 protagonizó por primera vez una novela en el prime time con “Esperanza
                                        Mía”, y se convirtió en un éxito rotundo. Lali logró ampliar su público juvenil
                                        a toda la familia, llegando a millones de hogares cada día. La actriz volvió a
                                        demostrar su rango actoral en la pantalla grande. Primero con la comedia
                                        “Permitidos” (2013) y luego en “Acusada” (2018), largometraje dramático que
                                        representó a nuestro país en el Festival Internacional de Cine de Venecia.</p>
                                    <p>En paralelo a su trabajo actoral, la artista desarrolló una importante carrera
                                        musical. Con cuatro álbumes de estudio -“A Bailar” (2013), “Soy” (2016), “Brava”
                                        (2018) y “Libra” (2020)-, giras en el interior y exterior de Argentina,
                                        múltiples colaboraciones y éxitos musicales, trascendió en la industria musical
                                        definiéndose como una de las líderes femeninas del pop latino.</p>
                                    <p>A su vez cosechó premios y galardones relevantes como el “Premio MTV Europe Music
                                        Awards”, “Premios Billboard”, ”Fans Choice Awards”, ‘E! Awards”, “Heat Latin
                                        Music Awards” “Kids Choice Awards”, “Gaviotas de Oro y Plata de Viña del Mar”,
                                        por solo mencionar algunos. Además, protagonizó las portadas de revistas como
                                        “Marie Claire”, “Vogue Latinoamérica”, “Galore”, “Elle”, “Billboard”, “Rolling
                                        Stone”, entre otras.</p>
                                    <p></p>
        ...
        <section>
            ...
            <ul>
                <li class=" bg-white rounded-lg shadow "> {{-- primera --}}
                    <article>
                        <figure>
                            <img class=" w-full object-cover" src="{{ asset('../img/C-2.svg') }}" alt="">
                        </figure>
                        <div class="py-4 px-4 justify-between items-center">
                            <h2 class="text-xl font-serif  font-bold pb-6">
                                <a href="">Reconocen a cirujanas por su lucha</a>
                            </h2>
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 shrink-0 ">
                                <div class=" font-sans text-lg text-left col-span-6  ">
                                    <p>Las profesionales homenajeadas desarrollan un constante esfuerzo colectivo para
                                        mejorar sus condiciones laborales.</p>
                                    <p>Los legisladores de la Ciudad declararon esta tarde como Personalidad Destacada
                                        en el ámbito de las Ciencias Médicas a la doctora y cirujana Irene María Rita
                                        Altuna. También establecieron de Interés la labor desarrollada en materia de
                                        género por la asociación civil Cirujanas Argentinas.</p>
                                    <p>El acto se llevó a cabo en el Salón Alfonsín y contó con la presencia de la
                                        diputada y autora del proyecto María Sol Méndez (VJ), la cirujana Irene María
                                        Rita Altuna, la presidenta de Cirujanas Argentinas Andrea Andreacchio, la
                                        coordinadora de protocolo Edurne Ormaechea y el doctor Jorge Manrique.</p>
                                    <p>“Es muy importante y simbólico hacer este reconocimiento durante esta semana en
                                        el mes del Día Internacional de la Mujer”, destacó Méndez en el comienzo de las
                                        alocuciones. Además subrayó la importancia del protocolo contra la violencia de
                                        género. “Visibilizar esto en la Legislatura, que haya sido aprobado por la
                                        mayoría y darle impulso es una herramienta que tenemos que hacerlo para poder
                                        alzar la voz y poder llevarla a todos lados”, agregó la legisladora.</p>
                                    <p>Por su parte Altuna agradeció al Palacio Legislativo por el reconocimiento y lo
                                        hizo extensivo “a todas las mujeres cirujanas argentinas, que de manera
                                        silenciosa y esforzada continúan en sus puestos de trabajo cumpliendo su
                                        vocación quirúrgica”. A su vez informó que el 82% de las estudiantes de la
                                        Facultad de Medicina de la Ciudad de Buenos Aires y el 66% de las ingresantes en
                                        las residencias médicas son mujeres.</p>
                                    <p>“Las instituciones hoy deben conocer la existencia de leyes y políticas de
                                        promoción de igualdad de género y aplicarlas. Las sociedades quirúrgicas deben
                                        contemplar la igualdad de género cuando designa puestos de liderazgo en su
                                        comité”, puntualizó la cirujana. Y pidió por la aceptación del problema y su
                                        abordaje “de manera transparente”.</p>
                                    <p>Andreacchio remarcó que el mayor objetivo de la asociación es “hacernos visibles
                                        y que no se nos olvide”. También resaltó la figura de Irene: “No solamente se
                                        merece el reconocimiento de la Legislatura, sino también de todas nosotras por
                                        haber llegado donde llegó y por haber hecho lo que hizo”.</p>
                                    <p>En tanto que Ornaechea contó cómo nació el protocolo y señaló que la prevención
                                        “va acompañada de erradicar todas las violencias de género”. Por último,
                                        Manrique contó cómo conoció a Altuna y concluyó: “Esta reunión es muy
                                        interesante porque está plasmando un mundo que ya se fue. Ahora se viene el
                                        mundo de mis hijas y de mis nietas, que espero que sea más armónico”.</p>
                                    <p></p>
