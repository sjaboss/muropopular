<footer class="custom-footer bg-dark py-1 position-relative">
    <div class="container">
        <div class="row">
            ...
            <div class="row text-center text-sm-start align-items-center mt-5">
                ...
                <div class="mb-12 md:mb-0 text-right">
                    <div class="flex m-2 space-x-5 sm:justify-center sm:mt-0">
                        ...
                        <a href="https://www.instagram.com/adnpopulares?utm_source=qr&igsh=M2xrd2Y4eWNjMDZ3"
                            target="_blank">
                ...
                <hr class="my-6 border-gray-700 lg:my-12" />
                <div class="sm:flex sm:items-center sm:justify-between">
                    <span class="text-sm text-gray-500 sm:text-center">© 2024 <a class="hover:underline">Cooperativa
                            de
                            Trabajo
