...
{{--ALBERDI EN LOS BILLETES: REPUDIO FAMILIAR A LA UTILIZACIÓN DEL PRÓCER  --}}
<section>
            <ul>
                <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                    <article>
...
{{-- GRABOIS DENUNCIA VIOLENCIA INSTITUCIONAL EN ALLANAMIENTO A DIRIGENTA SOCIAL --}}
<section>
    <ul>
        <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
            <article>
...
{{-- CÁMARA DE DIPUTADOS APRUEBA VETO A LEY DE FINANCIAMIENTO UNIVERSITARIO --}}
<section>
            <ul>
                <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                    <article>
...
{{--MASIVA MARCHA FEDERAL UNIVERSITARIA CONTRA EL VETO DE MILEI  --}}
<section>
            <ul>
                <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                    <article>
...
{{--MILEI HUNDE AL PAÍS CON SU AJUSTE NEOLIBERAL--}}
<section>
...
{{--FRANCISCO CRITICÓ EL AJUSTE Y LA REPRESIÓN EN ARGENTINA --}}
<section>
            <ul>
                <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                    <article>
...
{{--MARCHA CONTRA EL VETO DE MILEI--}}
<section>
            <ul>
                <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                    <article>
...
{{--ESTUDIANTES SE MOVILIZAN CONTRA LOS VOUCHERS DE MILEI..  --}}
    <section>
        ...
        <section>
                            ...
                            <div
                                ...
                                <div class=" font-sans text-lg text-left col-span-6  ">
                                    ...
                                    <p>La lucha por la defensa de la democracia y los derechos humanos se
                                        ...
                                        Fernández, hija de Ana María Careaga y nieta de Esther Ballestrino,
                                        fundadora de Madres de Plaza de Mayo</b>, se ha convertido en una voz
                                    ...
                                    <p>El valiente testimonio de Ana Fernández resuena en un contexto en el
                                        ...
                                        valores democráticos</b>. Este llamado resuena en un contexto en el que
           ...
           {{--TAIANA HIZO ENTREGA DE EQUIPAMIENTO....  --}}
         <section>
            <ul>
                <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                    <article>
                            ...
                            <div
                                ...
                                <div class=" font-sans text-lg text-left col-span-6  ">
                                    ...
                                    <p><b>“Este material que costó mucho esfuerzo concretar es de
                                        extraordinaria importancia para la recuperación de capacidades del
                                        Ejército. Y merece un reconocimiento, ya que se trata de la segunda
                                        entrega que hacemos en el año de un equipamiento tan importante”</b>,
         ...
         {{--La Fragata ARA “Libertad” culminó su 51 ° Viaje de
                                    Instrucción....  --}}
         <section>
            <ul>
                <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                    <article>
                        ...
                        <div class="py-4 px-4 justify-between items-center">
                            <h2 class="text-xl font-serif  font-bold pb-6">
                                <a href="">LA FRAGATA ARA “LIBERTAD” CULMINÓ SU 51° VIAJE DE INSTRUCCIÓN</a>
                            </h2>
        ...
        {{--CADE LANZA SU CURSO "ENLATADOS CADE....  --}}
        <section>
            <ul>
                <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                    <article>
    ...
    {{--SE VIENE LA 44° EXPOSICIÓN NACIONAL ANGUS....  --}}
 <section>
    <ul>
        <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
            <article>
                ...
                <div class="py-4 px-4 justify-between items-center">
                    ...
                    <div
                        ...
                        <div class=" font-sans text-lg text-left col-span-6  ">
                            ...
                            <br>
                            <p><strong> “Es un sector productivo que produce más de 70 tipos de frutas y
                                hortalizas, con las cuales se alimentan más de catorce millones de
                                personas del conurbano bonaerense y otras regiones"</strong>, resaltó
                        ...
                        <div class="py-4 px-4 justify-between items-center">
                            ...
                            <div
                                ...
                                <div class=" font-sans text-lg text-left col-span-6  ">
                                    ...
                                    <br>
                                    <p><strong> “Compartir este almuerzo de aniversario de una institución icónica
                                        para nuestro municipio, además de las ganas, es un deber por estos
                                        46 años de historia y también de mucho futuro. Han pasado muchas
                                        generaciones por este lugar, hay también un compromiso de las nuevas
                                        generaciones de seguir trabajando y quiero que sepan que pueden
                                        contar con esta Intendenta”</strong>, expresó Mayra en El Fortín.
                                    </p>
                                    <br>
                                    ...
                                    <p>Por su parte, el titular de la institución, Walter Cabrera indicó:
                                       <strong> “Estamos muy contentos de que haya venido la Intendenta, para
                                        nosotros es un honor. Como presidente de la institución, el apoyo de
                                        los centros tradicionalistas no solo de El Fortín, sino de todos,
                                    ...
                                    <br>
                                    <p><strong> “Es un día especial porque tiene que ver con nuestro eje principal de
                                        ...
                                        encontramos y mejor del que vivimos nosotros”</strong>, analizó la
                                        Intendenta.
                                    </p>
                                    <br>
                    ...
                    <div
                        ...
                        <div class=" font-sans text-lg text-left col-span-6  ">
                            ...
                            <p>Federico, que tu ejemplo cunda entre los fiscales responsables,
                                ...
                                precisamente.</p>
                                <br>
                            <p>Ser fiscal de la nación es algo muy serio, lo demás es espectáculo de mal gusto.</p>
                                <br>
                                <p>Abrazamos tu valentía, tu decisión, y tu memoria estará siempre con nosotros. </p>
                                <br>
        ...
        <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
            <article>
                ...
                <div class="py-4 px-4 justify-between items-center">
                    ...
                    <figure>
                        <img class="h-screen w-full object-cover" src="../img/soc/soc_crecer1.svg"
                            alt="">
                    </figure>
                    <br>
                    <div
                        ...
                        <div class=" font-sans text-lg text-left col-span-6  ">
                            ...
                            <p>La ministra de Desarrollo Social de la Nación, Victoria Tolosa Paz,
                                ...
                                Derechos en la Literatura Infantil”</strong>, realizado en el Centro Cultural
                            ...
                            <p>"Soñábamos con el equipo del Ministerio y de la SENAF, hacer esta
                                actividad para<strong> visibilizar el enorme esfuerzo que hace el Estado
                                Nacional en acompañar los procesos de inclusión de las infancias</strong>,
                            ...
                            <p>"Sin el apoyo del gobierno nacional, sería impensado haber logrado
                                ...
                                Públicas de la Nación:<strong> 195 Espacios de Primera Infancia y Centros de
                                Desarrollo Infantil financiados</strong>, un logro que nos llena de orgullo
                                ...
                                Educación Inicial, la ministra de Desarrollo Social firmó un<strong> acuerdo
                                de colaboración con editoriales nacionales, para promover
                                producciones literarias que incorporen perspectivas de derechos de
                            ...
                            <p>“Es el Estado el que hace posible no solo la construcción de
                                ...
                                pone en valor,<strong> 7,8 millones de dólares de inversión</strong> del BID para
                                comprar<strong> libros, juegos y todo el equipamiento necesario</strong>, pensado y
                                repensado para los chicos y chicas de nuestra Patria", afirmó.
                            </p>
                            <br>
                            <p><strong> "Crecer con libros es crecer con derechos, y eso es lo que hacemos
                                todos los días para construir una Patria libre, justa e
                                igualitaria"</strong>, concluyó la titular de la cartera nacional.
                            </p>
                            <br>
                            <p>Las editoriales que suscribieron el acuerdo en esta instancia fueron<strong>
 ...
 <section>
    ...
    {{--INICIÓ EL PRIMER CURSO DEL PLAN FEDERAL DE CAPACITACIÓN.....  --}}
    <section>
        <ul>
            <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                <article>
                    ...
                    <div class="py-4 px-4 justify-between items-center">
                        ...
                        <div
                            ...
                            <div class=" font-sans text-lg text-left col-span-6  ">
                                ...
                                <br>
                                <p>La ministra de Desarrollo Social de la Nación,<strong> Victoria Tolosa Paz</strong>,
                                    participó del acto de apertura del primer curso del<strong> Plan Federal de
                                    Capacitación sobre Derechos de Niñas, Niños y Adolescentes, “Crecer
                                    con Derechos”</strong>, que se llevó a cabo en el Auditorio de la Jefatura de
                                ...
                                <p>El panel institucional de la apertura también expuso el secretario
                                    nacional de Niñez, Adolescencia y Familia,<strong> Gabriel Lerner</strong>; la
                                    defensora nacional de Derechos de niñas, niños y adolescentes,
                                    Marisa Graham; y la representante de Unicef en Argentina,<strong> Luisa
                                    Brumana</strong>. Además, estuvieron presentes, la ministra de Mujeres,
                                    Géneros y diversidad,<strong> Ayelen Mazzina</strong>, la secretaria de Gestión y
                                    Empleo Público,<strong> Ana Castellani</strong>; la secretaria de Deportes de la
                                    nación, Inés Arrondo; el director de INAP,<strong> Leandro Bottinelli</strong>; la
                                    diputada nacional<strong> Paola Vessvessian</strong>, entre otras autoridades
                                    nacionales.
                                </p>
                                <br>
                                ...
                                <P>Más de 2.400 personas se inscribieron al primer curso denominado
                                    <strong> “Violencias contra niñas, niños y adolescentes: Estrategias de
                                    prevención e intervención”</strong>, que se implementa a través de la
                                    plataforma virtual de SENAF, con una duración de cuatro semanas.</P>
                                <br>
        ...
        {{--MELAR, LA PYME FAMILIAR ARGENTINA.....  --}}
        <section>
            <ul>
                <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                    <article>
                        ...
                        <div class="py-4 px-4 justify-between items-center">
                            ...
                            <div
                                ...
                                <div class=" font-sans text-lg text-left col-span-6  ">
                                    ...
                                    <p><strong> Melar</strong> es una empresa que<strong> en 2024 cumplirá 100 años</strong> proveyendo
                                        ...
                                        incursionar en la apicultura con colmenas en<strong> Navarro</strong> y <strong> Azul</strong>,
                                    ...
                                    <p>Hasta<strong> 1976 Melar</strong> fue una empresa dedicada a la miel, a la producción
                                        y a la venta a granel exclusivamente y ese año comenzaron a
                                        fraccionar a través de su marca,<strong> Aquel Viejo Cosaco</strong>, con envases
                                        simples pero llamativos. Ya para<strong> 1986</strong> comenzaron a exportar miel a<strong>
                                        Bolivia</strong> y a<strong> Brasil</strong> entre otros países; mientras que paralelamente
                                        incursionaron en la importación de jalea real y polen adueñándose de
                                        un incipiente mercado local con mucha proyección. </p>
                                    <br>
                                    <p>La<strong> década del 90´</strong> fue de crecimiento e incorporación de nuevos
                                        productos y con el cambio de siglo comenzó un proceso de
                                        “profesionalización” en la empresa con la entrada de los nietos de
                                        los fundadores. </p>
                                    <br>
                                    <P><strong> Innovación y buena reputación, claves para la permanencia</strong></P>
                                    <br>
                                    <P><strong> Jorge Scoufalos</strong> , su<strong> gerente general</strong> , destaca que entre otras cosas
                                    ...
                                    <br>
                                    <P><strong> Melar</strong> tiene como gran objetivo para el 2023 obtener la<strong> certificación
                                        como Empresa B</strong>, demostrando así su compromiso con lo social y
                                    ...
                                    <br>
                                    <P>Con más de<strong> 1000 productos de 50 orígenes</strong> distintos; con su propia
                                        marca<strong> El Cosaco</strong> en pleno auge y en expansión; con más del 85% de los
                                        ...
                                        responsabilidad,<strong> Melar se encamina a cumplir 100 años en el país en
            ...
            <ul>
                <li class=" bg-white rounded-lg shadow "> {{-- primera --}}
                    <article>
                        <figure>
                            <figure>
                                <img class=" w-full object-cover" src="{{ asset('../img/S-1.svg') }}" alt="">
                            </figure>
                            <div class="py-4 px-4 justify-between items-center">
                                <h2 class="text-xl font-serif  font-bold pb-6">
                                    <a href="">Alcohol Cero: descendieron los casos de alcoholemia al volante en
                                        la Provincia</a>
                                </h2>
                                <div
                                    class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 shrink-0 ">
                                    <div class=" font-sans text-lg text-left col-span-6  ">
                                        <p>Con la llegada de febrero, la ley de Alcohol Cero impulsada por el Ministro
                                            D’Onofrio se afianza en la Provincia, apuntalando una merma en la cantidad
                                            de casos positivos detectados.</p>
                                        <p>El Ministerio de Transporte de la provincia de Buenos Aires, a cargo del
                                            ministro Jorge D’Onofrio, fortaleció durante los primeros días de febrero
                                            los operativos de control vehicular, verificación integral, alcoholemia,
                                            prevención y concientización en las calles y rutas bonaerenses. Las postas
                                            se emplazaron en zonas estratégicas del Operativo de Sol a Sol.</p>
                                        <p>De esta forma, la cartera provincial informó que entre el lunes 30 de enero y
                                            el domingo 5 de febrero se organizaron 130 frentes de servicio en los que se
                                            fiscalizaron 3324 vehículos.</p>
                                        <p>En este sentido, se llevaron a cabo 1332 test de alcoholemia de los cuales 28
                                            conductores dieron positivo de dicha sustancia en sangre. A su vez, los
                                            agentes de Seguridad Vial bonaerense labraron 140 infracciones y retuvieron
                                            79 licencias de conducir, conforme a diversos motivos que incumplían con la
                                            Ley de tránsito 13927.</p>
                                        <p>Los puntos donde se llevaron a cabo los operativos fueron: Azul, Cariló,
                                            Chascomús, Hudson, Maipú, Mar de Ajó, Mar del Plata, Monte Hermoso,
                                            Necochea, Pehuajó, Pinamar, San Andrés de Giles, San Bernardo, San Clemente,
                                            Santa Teresita, Tigre, Villa Gesell y Zárate.</p>
                                        <p>Así, en cumplimiento de la Ley de Alcohol Cero al Volante en la Provincia,
                                            los más de 1300 exámenes realizados determinaron que el ranking de
                                            localidades con positivo de alcoholemia al conducir lo sigue liderando Monte
                                            Hermoso con el 8% de casos confirmados respecto de la cantidad de test
                                            realizados; seguido por Pinamar con el 5,7% y San Clemente del Tuyú, en el
                                            Partido de La Costa, con 3,5%. </p>
                                        <p>En contrapartida, Balcarce, Mar del Plata, Mar del Tuyú y Necochea, entre
                                            otras ciudades, no registraron positivos en los retenes que se llevaron a
                                            cabo. Asimismo, vale destacar que, respecto a las primeras semanas del año,
                                            Monte Hermoso tuvo una merma en la cantidad de casos de alcoholemia
                                            registrados pasando del 33,3% al 15% y, actualmente, a un 8%.</p>
                                        <p>En tanto, también en el marco del Operativo de Sol a Sol, las y los agentes
                                            de la Dirección Provincial de Fiscalización del Transporte Terrestre,
                                            dependiente de la Subsecretaría de Transporte Terrestre del Ministerio de
                                            Transporte bonaerense, fiscalizaron 630 vehículos a lo largo de la última
                                            semana y labraron 15 infracciones por irregularidades en la documentación
                                            habilitante para circular.</p>
        ...
        <section>
            <ul>
                <li class=" bg-white rounded-lg shadow "> {{-- primera --}}
                    <article>
                        <figure>
                            <img class=" w-full object-cover" src="{{ asset('../img/S-2.svg') }}" alt="">
                        </figure>
                        <div class="py-4 px-4 justify-between items-center">
                            <h2 class="text-xl font-serif  font-bold pb-6">
                                <a href="">“SECTORES DEL PODER POLÍTICO, JUDICIAL Y POLICIAL DE RÍO NEGRO
                                    RESPONDEN A JOE LEWIS”</a>
                            </h2>
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 shrink-0 ">
                                <div class=" font-sans text-lg text-left col-span-6  ">
                                    <p>Esta madrugada finalizó la Séptima Marcha por la Soberanía que organiza la Fipca,
                                        que preside Julio Urien, y de la que la Federación de Trabajadores de la
                                        Energía, la Industria, Servicios y Afines (FETIA-CTA-T), que conduce Pedro
                                        Wasiejko, viene participando desde hace varias ediciones. A las 3.10 de la
                                        mañana, quienes participaron de la movilización por el camino de Tacuifí se
                                        reunieron con quienes fueron parte de la actividad por el camino de montaña.</p>
                                    <p>“Como sucedió en el camino público del Tacuifí y en el aeropuerto que Lewis
                                        construyó en la costa atlántica rionegrina en Playas Doradas, hubo hostigamiento
                                        por parte de la mano de obra de Lewis y Van Ditman y un dejar hacer por parte de
                                        la policía rionegrina. Las agresiones están documentadas y denunciadas pero,
                                        como parte del Poder Judicial y político responde a Lewis en lugar de garantizar
                                        nuestras leyes y defender nuestra soberanía, resultará difícil que se condene a
                                        los agresores”, denunció Rubén Ciuró, secretario de Derechos Humanos de la FETIA
                                        y participante de la movilización en el sur argentino.</p>
                                    <p>Cabe recordar que el pasado 2 de febrero las personas que estaban intentando
                                        ingresar al Lago Escondido por el sendero público fueron agredidas con caballos
                                        y rebenques frente a la inacción de las fuerzas policiales, a pesar del fallo
                                        judicial que dictamina que se debe garantizar el acceso a este lago. </p>
                                    <p>Desde hace años la FETIA participa de esta movilización junto a organizaciones
                                        sociales, políticas y sindicales populares para exigir que se abran los caminos
                                        públicos, tal como lo determinó el Poder Judicial y denunciar la complicidad
                                        política y policial con Joe Lewis. Este año la movilización adquirió doble
                                        relevancia tras conocerse la escandalosa reunión de integrantes del Poder
                                        Judicial federal que operan en Comodoro Py con las máximas autoridades del Grupo
                                        Clarín y funcionarios del Gobierno de la CABA en la estancia de Lewis.</p>
                                    <p>“Con orgullo, como en marchas anteriores, nuestra Federación de Trabajadores de
                                        la Industria Argentina estuvo presente en esta actividad. En esta ocasión
                                        participamos en las tres instancias de actividad de la Marcha: Tacuifí, montaña
                                        y Playas Doradas. Anoche, emocionados, recibimos a Alejandro Figueredo, de
                                        SOEP-FeTIA Misiones, integrante, una vez más, de la columna de montaña, junto a
                                        otros compañeros, compañeras y organizaciones”, agregó Ciuró.</p>
                                    <p>Para finalizar el secretario de Derechos Humanos de la FETIA sostuvo que “no hay
                                        desarrollo nacional ni distribución de la riqueza posibles sin soberanía
                                        nacional, tanto en Lago Escondido como en nuestras Islas Malvinas así como
                                        también en el Paraná”.</p>
        ...
        <section>
            <ul>
                <li class=" bg-white rounded-lg shadow "> {{-- primera --}}
                    <article>
                        <figure>
                            <img class=" w-full object-cover" src="{{ asset('../img/S-3-1.svg') }}" alt="">
                        </figure>
                        <div class="py-4 px-4 justify-between items-center">
                            <h2 class="text-xl font-serif  font-bold pb-6">
                                <a href="">Primera edición de la “Copa Alfredo Proud 2023” en las playas de
                                    Chapadmalal.</a>
                            </h2>
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 shrink-0 ">
                                <div class=" font-sans text-lg text-left col-span-6  ">
                                    <p>Durante un día abrasador de febrero, conversamos con Diego Scarmato, timonel de
                                        rescate de Chapa 5 mientras se estaba desarrollando un homenaje a Alfredo Proud,
                                        jefe de los guardavidas de Chapadmalal.</p>
                                    <p>Entre todas y todos tomaron la idea de Scarmato y coincidieron en organizar este
                                        agasajo que consistía en una competencia de rescate en su lugar de pertenencia,
                                        como demostración de la tarea diaria de estos trabajadores en la playa.</p>
                                    <p>En los hoteles del Complejo Turístico de Chapadmalal los y las guardavidas que
                                        realizan esta tarea varían entre 24 y 25, dependiendo de la época y del tramo de
                                        la temporada.</p>
                                    <p>Cada playa tiene varios puestos, que cuentan con dos guardavidas, en dos turnos,
                                        mañana y tarde. Asimismo se instaló una base náutica como embarcación de rescate
                                        de apoyo, con dos timoneles por la mañana y por la tarde, para accionar frente a
                                        cualquier situación fuera del alcance de los profesionales socorristas.</p>
                                    <p>El homenajeado, Alfredo Proud es un histórico de la actividad, que gracias a su
                                        buena voluntad, a su predisposición, y gran experiencia le dieron la jefatura de
                                        Chapadmalal. La figura de Alfredo logró que dos de los sindicatos que
                                        representan a los agremiados, –Sindicato de Guardavidas de Gral. Pueyrredón,
                                        Unión Guardavidas Agremiados, más algunos independientes-, coincidan en este
                                        encuentro en su primera edición.</p>
        ...
        <section>
            <ul>
                <li class=" bg-white rounded-lg shadow "> {{-- primera --}}
                    <article>
                        <figure>
                            <img class=" w-full object-cover" src="{{ asset('../img/S-3.svg') }}" alt="">
                        </figure>
                        <div class="py-4 px-4 justify-between items-center">
                            <h2 class="text-xl font-serif  font-bold pb-6">
                                <a href="">ARA San Juan: Casi la totalidad de los hijos de los tripulantes se
                                    inscribieron en las becas de apoyo educativo</a>
                            </h2>
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 shrink-0 ">
                                <div class=" font-sans text-lg text-left col-span-6  ">

                                    <p>En el marco del Plan de Becas de Estudio destinadas a los hijos de los
                                        tripulantes fallecidos en el hundimiento del submarino ARA “San Juan" que
                                        anunció el ministro Taiana al cumplirse cinco años del naufragio, el Ministerio
                                        de Defensa informa que a la fecha son 34 los becarios que empezarán a cobrar
                                        este beneficio destinados a solventar los gastos que demande la educación en los
                                        niveles pre-escolar, primario, secundario y superior–universitario o no
                                        universitario.</p>
                                    <p>Dicho plan de becas de educación que fue estipulado por Resolución
                                        2022-1430-APN-MD de fecha 12 de noviembre de 2022, es ejecutado por el Instituto
                                        de Ayuda Financiera para el Pago de Retiro y Pensiones Militares, dependiente
                                        del Ministerio de Defensa.</p>
                                    <p>El objetivo del plan es brindar por medio de una beca estudiantil, una ayuda
                                        económica para solventar los costos de matrícula, libros y otros gastos
                                        relacionados a tal fin.</p>
                                    <p>Entre los requisitos necesarios se establece que el padre o madre del becario o
                                        becaria hayan fallecido en la tragedia del ARA San Juan; que el beneficiario
                                        resida en el país; que el beneficiario acredite el carácter de alumno regular y
                                        que sea beneficiario de pensión del IAFPRPM, como hijo de un titular militar
                                        fallecido de acuerdo con las condiciones establecidas en la Ley 19.101.</p>
                                    <p>La percepción de la beca consiste en un pago mensual durante el ciclo lectivo,
                                        según el siguiente detalle: para niños de nivel inicial o primario de $60.000; y
                                        para estudiantes secundarios, terciarios o universitarios de $75.000.</p>
                                    <p>La implementación de estos 34 becarios se efectivizará con los haberes de febrero
                                        que se perciben en marzo de 2023. </p>
                                    <p>Asimismo, quedan pendientes la presentación de cuatro hijos (futuros
                                        becarios/as), correspondientes a tres tripulantes, que ya han presentado los
                                        trámites de pensión. A la presentación de los certificados de escolaridad
                                        correspondientes se les abonará la beca, con retroactivo al mes de febrero de
                                        2023.</p>
                                    <p>El Submarino A.R.A. “SAN JUAN” partió el 15 de noviembre de 2017 desde el Puerto
                                        de Ushuaia en cumplimiento de una misión oficial con una dotación de 44
                                        tripulantes, todos ellos pertenecientes a los cuadros permanentes de la Armada
                                        Argentina.</p>
