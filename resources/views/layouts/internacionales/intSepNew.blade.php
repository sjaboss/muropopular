<x-app-layout>
    <div class="container ">
        ...
        <div class="mt-10"></div>
        @if ($tituloSep == 'Internacionales-Noticia-Completa-int1')
            <section>
                                ...
                                <article>
                                    ...
                                    <div class="py-4 px-4 justify-between items-center">
                                        <h2 class="text-xl font-serif  font-bold pb-6">
                                            <a href="">ARGENTINA EN LOS BRICS</a>
                                        </h2>
                                        <p>Retomando lo que escribimos el Martes 22 en el Artículo “LOS BRICS PUEDEN
                                            ...
                                            el “apagar las luces”.</p>
                                        <br>
                                        <figure>
                                            <img class=" w-full object-cover" src="../img/int/int-brics1.svg"
                                                alt="">
                                        ...
                                        <div
                                            ...
                                            <div class=" font-sans text-lg text-left col-span-6  ">
                                                ...
                                                <p>Estas idas y vueltas se debían, como dijimos el martes, a la
                                                    ...
                                                    al SWIFT (acrónimo de las siglas en inglés de<strong> “Society for
                                                        Worldwide
                                                        Interbank Financial Telecommunication”)</strong> como premisa
                                                    para lo que
                                                    ...
                                                    mediante la amenaza de dejarlos fuera del sistema.</p>
                                                <br>


                                                <p>Volviendo al miércoles, el día “D”, a primera hora algunas fuentes de
                                                    ...
                                                    más alegría, entre ellos estaría la Argentina. </p>


                                                <p>El analista internacional Atilio Borón lo resumió muy bien en radio
                                                ...
                                                <br>
                                                <p>Tal vez nunca sepamos cómo se convenció al presidente del país
                                                    ...
                                                    Pandor en la radio pública Ubuntu al atardecer. </p>
                                                <br>

                                                <p>En esas vertiginosas negociaciones, hay que destacar la impresionante
                                                    ...
                                                    estadista regional y global.</p>
                                                <br>
                                                <p>Este apoyo brasileño, en la actual coyuntura electoral en Argentina,
                                                ...
                                                <br>
                                                <p>Una de las principales ventajas es que, en los BRICS, a diferencia de
                                                ...
                                                <br>
                                                <p>Además, los BRICS favorecen el uso de las Monedas Nacionales en el
                                                ...
                                                <br>
                                                <p>Para finalizar, como apuntó Martín Granovsky en Página 12,<strong>
                                                        “Comienza
                                                        a concretarse un nivel de institucionalización de vínculos
                                                        reales
                                                ...
                                                <br>
                                                <p>Por ello, más allá de algunas declaraciones en contra de la
                                                ...
                                                <figure>
                                                    ...
                                                    <p> <strong>Nota de Ramiro Caggiano Blanco.</strong></p></a>
                                                </figure>
                                                <br>
                                            </div>
                        ...
                        <ul>
                            ...
                            <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                                <article>
                                    ...
                                    <div class="py-4 px-4 justify-between items-center">
                                        <h2 class="text-xl font-serif  font-bold pb-6">
                                            <a href="../img/int/int-paz2.svg">PAÍSES DE TODA LA REGIÓN FIRMARON UNA
                                                DECLARACIÓN PARA
                                        ...
                                        <br>
                                        <figure>
                                            <a href="../img/int/int-paz2.svg"> <img class="h-80 w-full object-cover"
                                                    src="../img/int/int-paz2.svg" alt=""></a>
        ...
        @elseif ($tituloSep == 'Internacionales-Noticia-Completa-int3')
            <section>
                <div class="grid grid-cols-1 pl-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 shrink-0 ">
                    <div class=" col-span-4">
                                    ...
                                    <div class="py-4 px-4 justify-between items-center">
                                        ...
                                        <div
                                            ...
                                            <div class=" font-sans text-lg text-left col-span-6  ">
                                                ...
                                                <p><i>Lagos, Nigeria, 3 de octubre de 2023 - Una tragedia sacudió a
                                                        Nigeria
        ...
        @elseif ($tituloSep == 'Internacionales-Noticia-Completa-int5')
            <section>
                <div class="grid grid-cols-1 pl-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 shrink-0 ">
                    <div class=" col-span-4">
        ...
        @elseif ($tituloSep == 'Internacionales-Noticia-Completa-int6')
            <section>
                <div class="grid grid-cols-1 pl-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 shrink-0 ">
                    <div class=" col-span-4">
                        ...
                        <ul>
                            <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                                <article>
                                    ...
                                    <div class="py-4 px-4 justify-between items-center">
                                        <h2 class="text-xl font-serif  font-bold pb-6">
                                            <a href="">GOLPES EN ÁFRICA: EL CASO DE BURKINA FASO</a>
                                        </h2>
                                        <p><i>En los medios de comunicación, salvo honrosas excepciones, mucho se habla
                                                de
                                                los golpes en África, como si fuesen un fenómeno local sin conexión con
                                                la
                                                geopolítica mundial, pero poco se dice de las múltiples causas más allá
                                                de
                                                explicaciones simplistas. Ocurre que no es fácil encontrar datos
                                                confiables
                                                debido a la poca atención que la prensa occidental, y sus satélites, le
                                                han
                                                prestado a la “cuestión africana”. Sin pretender dar cuenta de los
                                                innúmeros
                                                lados de esta realidad, en estas líneas nos proponemos señalar algunos
                                                elementos esenciales que sueles omitirse en los medios hegemónicos.</i>
                                        </p>
                                        <br>
                                        <figure>
                                            <img class=" w-full object-cover" src="../img/int/int_afri3.svg"
                                                alt="">
                                        ...
                                        <div
                                            ...
                                            <div class=" font-sans text-lg text-left col-span-6  ">
                                                ...
                                                <p>Una seguidilla de golpes de estado se viene desarrollando en África
                                                ...
                                                <p>La explicación más corriente es de que son fruto de la relación
                                                    ...
                                                    económicas de los países en los que circula.</p>


                                                <p>Aunque haya mucho de verdad en eso, hay que buscar más allá de las
                                                    ...
                                                    que han sufrido golpes de estado en los últimos años<b> “son
                                                        desproporcionadamente pobres, tienen una historia reciente de
                                                        golpes
                                                        de Estado y enfrentan dilemas continuos de consolidación
                                                        democrática”</b>. Hasta aquí, nada nuevo. Inclusive podría
                                                    extenderse a
                                                    muchos otros países africanos y de otras partes del mundo. Sin
                                                    embargo, afortunadamente echa un poco de luz al destacar que<b> “las
                                                        insurgencias islamistas en curso pueden haber contribuido a
                                                        precipitar los recientes golpes de estado en África occidental,
                                                        pero
                                                        no en otros lugares”</b>. Y en ello coincide con el analista
                                                    Thierry
                                                ...
                                                <br>
                                                <p>El fin del gobierno de Kadhafi despertó una onda de “masacres contra
                                                    ...
                                                    del<b> Grupo Wagner</b> para contener la amenaza terrorista
                                                    islamista. </p>
                                                <br>

                                                <p>Tras Mali, se sucedieron otros golpes de estado como efecto dominó.
                                                    Sin embargo, hay que diferenciar a Gabón y Guinea, países en los
                                                    cuales los golpes de estado tienen características propias.</p>
                                                <br>
                                                <p>En relación a Gabón, en donde se desencadenó el último golpe el 30 de
                                                    ...
                                                    el primo de Alí, <b>Olinguí Nguemá</b>.
                                                </p>
                                                <br>
                                                <figure>
                                                    <img class=" w-full object-cover" src="../img/int/int_afri1.svg"
                                                        alt="">

                                                </figure>
                                                <br>
                                                <p>Según Meyssan, otro tanto habría ocurrido en Guinea: los militares se
                                                ...
                                                <br>
                                                <p>Volviendo a los países del Sahel, hay que destacar que Burkina Faso,
                                                ...
                                                <br>
                                                <p>Recordemos que, además del orgullo francés magullado y de
                                                    ...
                                                    el gobierno nigerino del general <b>Abduraman Tchiani le exige el
                                                        pago
                                                        de 200 euros por kg de uranio, conforme el precio internacional,
                                                        mientras que antes Francia lo pagaba 0,80 euros</b>. O sea, los
                                                ...
                                                <br>
                                                <p>Luego de esta somerísima e incompleta descripción contextual,
                                                ...
                                                <br>
                                                <p>En primer lugar, diremos que, a diferencia de su vecino Mali, el
                                                    ...
                                                    dependencia de ejércitos mercenarios.</p>
                                                <br>
                                                <p>En lo relativo a las obras de gobierno, la administración Traoré está
                                                    ...
                                                    personas como para el comercio.</p>
                                                <br>
                                                <p>Además, está construyendo un nuevo aeropuerto que reemplazará al
                                                    actual aeropuerto internacional Thomas Sankara, lo que generará
                                                    5.000 puestos de trabajo directos e indirectos.</p>
                                                <br>
                                                <p>Está llevando adelante programas de emprendedurismo múltiple, con
                                                    empresas de propiedad comunitaria, con prioridades en la minería,
                                                    agricultura e industria.</p>
                                                <br>
                                                <p>En materia energética, desarrolla un programa de electrificación
                                                    ...
                                                    que producirá energía y proveerá agua para irrigación.</p>
                                                <br>
                                                <p>En lo social, puso en marcha un programa de acceso al agua limpia y
                                                ...
                                                <br>
                                                <p>En materia política, Traoré anunció una transición para llamar a
                                                    elecciones y constituir un gobierno civil elegido democráticamente.
                                                </p>
                                                <br>
                                                <p>Sin embargo, podemos decir, a riesgo de equivocarnos, que es la
        ...
        @elseif ($tituloSep == 'Internacionales-Noticia-Completa-int7')
            <section>
                <div class="grid grid-cols-1 pl-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 shrink-0 ">
                    <div class=" col-span-4">
                        ...
                        <ul>
                            <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                                <article>
                                    ...
                                    <div class="py-4 px-4 justify-between items-center">
                                        <h2 class="text-xl font-serif  font-bold pb-6">
                                            <a href="">DENUNCIAN A ÁLVARO URIBE EN ARGENTINA POR PRESUNTA
                                                IMPLICACIÓN EN FALSOS POSITIVOS</a>
                                        </h2>
                                        <p><i><b>Once víctimas y tres ONG colombianas presentan demanda histórica ante
                                                    la justicia argentina</b></i>
                                        </p>
                                        <br>
                                        <figure>
                                            <img class=" w-full object-cover" src="../img/int/int_uribe.svg"
                                                alt="">
                                        ...
                                        <div
                                            ...
                                            <div class=" font-sans text-lg text-left col-span-6  ">
                                                ...
                                                <p>En un paso sin precedentes en la lucha contra la impunidad en
                                                    ...
                                                    justificándolos como guerrilleros muertos en combate.</p>
                                                <br>
                                                <p>El Juez instructor Sebastián Ramos será el encargado de llevar
                                                    ...
                                                    significativo para la figura política de Álvaro Uribe.</p>
                                                <br>
                                                <p>La denuncia, respaldada por el Colectivo de Abogados José Alvear
                                                ...
                                                <br>
                                                <p>Cajar destacó la trascendencia de esta acción como un "paso histórico
                                                    ...
                                                    magnitud de los presuntos crímenes.</p>
                                                <br>
                                                <p>Álvaro Uribe, por su parte, respondió a la denuncia a través de sus
                                                ...
                                                <br>
                                                <p>La querella presentada en Argentina representa un hito significativo
        ...
        @elseif ($tituloSep == 'Internacionales-Noticia-Completa-int8')
            <section>
                <div class="grid grid-cols-1 pl-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 shrink-0 ">
                    <div class=" col-span-4">
                        ...
                        <ul>
                            <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                                <article>
                                    ...
                                    <div class="py-4 px-4 justify-between items-center">
                                        <h2 class="text-xl font-serif  font-bold pb-6">
                                            <a href="">CUBA SE ENFRENTA AL DESAFÍO DE MEJORAR LA CALIDAD DE LA
                                                SALUD PÚBLICA CON UN NUEVO ENFOQUE INTEGRAL</a>
                                        </h2>
                                        <p><i>Cuba se prepara para debatir un anteproyecto crucial: la Ley de Salud
                                                Pública, que busca transformar y perfeccionar la actividad sanitaria del
                                                país.</i>
                                        </p>
                                        <br>
                                        <figure>
                                            <img class=" w-full object-cover" src="../img/int/int_cuba.svg"
                                                alt="">
                                        ...
                                        <div
                                            ...
                                            <div class=" font-sans text-lg text-left col-span-6  ">
                                                ...
                                                <p>Presentada recientemente, la propuesta destaca un nuevo enfoque
                                                    ...
                                                    multidisciplinaria.</p>
                                                <br>
                                                <p>Durante el próximo período ordinario de sesiones de diciembre, la
                                                    ...
                                                    actualizar la legislación existente desde 1983.</p>
                                                <br>
                                                <p>El anteproyecto se alinea con la Constitución de 2019 y se enfoca en
                                                ...
                                                <br>
                                                <p>Por primera vez, se incorpora el concepto de atención, protección y
                                                    ...
                                                    interés superior de niñas, niños y adolescentes.</p>
                                                <br>
                                                <p>La Dra. Tania Margarita Cruz Hernández, viceministra primera del
                                                    ...
                                                    digital en la gobernanza del país.</b>.
                                                </p>
                                                <br>
                                                <p>La nueva ley pretende mejorar la salud de la población, fortalecer
                                                ...
                                                <br>
                                                <p>Entre las novedades, se resalta el papel de la ética médica en la
                                                ...
                                                <br>
                                                <p>Este anteproyecto representa un paso significativo hacia una salud
        ...
        @elseif ($tituloSep == 'Internacionales-Noticia-Completa-int9')
            <section>
                <div class="grid grid-cols-1 pl-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 shrink-0 ">
                    <div class=" col-span-4">
        ...
        @elseif ($tituloSep == 'Internacionales-Noticia-Completa-int10')
            <section>
                <div class="grid grid-cols-1 pl-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 shrink-0 ">
                    <div class=" col-span-4">
                        <ul>
        ...
        @elseif ($tituloSep == 'Internacionales-Noticia-Completa-int11')
            <section>
                <div class="grid grid-cols-1 pl-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 shrink-0 ">
                    <div class=" col-span-4">
                        <ul>
                            <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                                <article>
                                    ...
                                    <div class="py-4 px-4 justify-between items-center">
                                        <h2 class="text-xl font-serif  font-bold pb-6">
                                            <a href="">CUBA: MULTITUDINARIO ACTO CONTRA EL GENOCIDIO DE ISRAEL EN GAZA</a>
                                        ...
                                        <p>En Hiroshima y Nagasaki un huracán radioactivo siguió a un flashazo desintegrador de la existencia y la obra humanas. No hubo tiempo de despedidas ni de besarse unos a otros. Tampoco para poner a resguardo los recuerdos de familia sin sospechar que tampoco quedaría esta.
                                        </p>
                                        <br>
                                        <figure>
                                            <img class=" w-full object-cover" src="../img/int/int_gaza.svg"
                                                alt="">
                                        ...
                                        <div
                                            ...
                                            <div class=" font-sans text-lg text-left col-span-6  ">
                                                ...
                                                <p>La historia comenzaría otro curso. Como un detergente social, bombas de otro tipo irían limpiando con el tiempo la memoria para quitar la mancha a quienes envilecieron tanto la especie. En Palestina, como en 1945, se repite hoy un horror indescriptible del cual el mundo es testigo.</p>
                                                <br>
                                                <p>No permitamos que la historia la cuenten solo los culpables y los impunes. Cuba volvió a hablar este sábado y a decir la verdad en el Malecón de La Habana, muy cerca de los oídos sordos de los mercaderes de la muerte.</p>
                                                <br>
        ...
        @elseif ($tituloSep == 'Internacionales-Noticia-Completa-int13')
            <section>
                <div class="grid grid-cols-1 pl-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 shrink-0 ">
                    <div class=" col-span-4">
                        <ul>
        ...
        @elseif ($tituloSep == 'Internacionales-Noticia-Completa-int14')
            <section>
                <div class="grid grid-cols-1 pl-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 shrink-0 ">
                    <div class=" col-span-4">
                        <ul>
        ...
        @elseif ($tituloSep == 'Internacionales-Noticia-Completa-int22')
            <section>
                <div class="grid grid-cols-1 pl-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 shrink-0 ">
                    <div class=" col-span-4">
                        <ul>
        ...
        @elseif ($tituloSep == 'Internacionales-Noticia-Completa-int23')
            <section>
                <div class="grid grid-cols-1 pl-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 shrink-0 ">
                    <div class=" col-span-4">
                        <ul>
        ...
        @elseif ($tituloSep == 'Internacionales-Noticia-Completa-int24')
            <section>
                <div class="grid grid-cols-1 pl-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 shrink-0 ">
                    <div class=" col-span-4">
                        <ul>
        ...
        @elseif ($tituloSep == 'Internacionales-Noticia-Completa-int25')
            <section>
                <div class="grid grid-cols-1 pl-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 shrink-0 ">
                    <div class=" col-span-4">
                        <ul>
        ...
        @elseif ($tituloSep == 'Internacionales-Noticia-Completa-int26')
            <section>
                <div class="grid grid-cols-1 pl-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 shrink-0 ">
                    <div class=" col-span-4">
                        <ul>
        ...
        @elseif ($tituloSep == 'Internacionales-Noticia-Completa-int28')
            <section>
                <div class="grid grid-cols-1 pl-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 shrink-0 ">
                    <div class=" col-span-4">
                        <ul>
        ...
        @elseif ($tituloSep == 'Internacionales-Noticia-Completa-int29')
            <section>
                <div class="grid grid-cols-1 pl-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 shrink-0 ">
                    <div class=" col-span-4">
                        <ul>
        ...
        @elseif ($tituloSep == 'Internacionales-Noticia-Completa-int30')
            <section>
                <div class="grid grid-cols-1 pl-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 shrink-0 ">
                    <div class=" col-span-4">
                        <ul>
        ...
        @elseif ($tituloSep == 'Internacionales-Noticia-Completa-int33')
            <section>
                <div class="grid grid-cols-1 pl-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 shrink-0 ">
                    <div class=" col-span-4">
                        <ul>
        ...
        @elseif ($tituloSep == 'Internacionales-Noticia-Completa-int34')
            <section>
                <div class="grid grid-cols-1 pl-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 shrink-0 ">
                    <div class=" col-span-4">
                        <ul>
        ...
        @elseif ($tituloSep == 'Internacionales-Noticia-Completa-int35')
            <section>
                <div class="grid grid-cols-1 pl-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 shrink-0 ">
                    <div class=" col-span-4">
                        <ul>
        ...
        @elseif ($tituloSep == 'Internacionales-Noticia-Completa-int36')
            <section>
                <div class="grid grid-cols-1 pl-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 shrink-0 ">
                    <div class=" col-span-4">
                        <ul>
