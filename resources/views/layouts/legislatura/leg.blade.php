...
{{--LEGISLATURA IMPULSA LA LUCHA CONTRA EL CÁNCER DE MAMA  --}}
<section>
            <ul>
                <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                    <article>
...
{{--LA LEGISLATURA ENTREGÓ UN BENEPLÁCITO A LA AFA  --}}
<section>
            <ul>
                <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                    <article>
...
{{-- FERNANDO TROCCA, PERSONALIDAD DESTACADA EN CULTURA --}}
<section>
            <ul>
                <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                    <article>
...
<section>
    ...
    <section >
        ...
        {{--LIBRO "POETAS ARGENTINOS, AMIGOS DE MARRUECOS" DECLARADO DE INTERÉS CULTURAL --}}
        <section >
            <ul>
                <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                    <article>
        ...
        {{--LA LEGISLATURA APROBÓ MODIFICACIONES A LA LEY 6505 --}}
        <section >
            <ul>
                <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                    <article>
        ...
        {{--ERNESTO CHERQUIS BIALO FUE DECLARADO COMO PERSONALIDAD DESTACADA DE LA CIUDAD --}}
        <section >
            <ul>
                <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                    <article>
    ...
    {{--LA LEGISLATURA APROBÓ LA LEY DE REITERANCIA.. --}}
        ...
        {{--En el aniversario  de “Ni una Menos”.. --}}
        <section >
            <ul>
                <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                    <article>
        ...
        {{--JOSÉ TCHERKASKI ES PERSONALIDAD DESTACADA DE LA CIUDAD.. --}}
        <section >
            <ul>
                <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                    <article>
        ...
        {{--DÍA INTENSO EN LA LEGISLATURA: CULTURA, MUJERES Y DERECHOS HUMANOS..... --}}
        <section >
            <ul>
                <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                    <article>
        ...
        {{--AVANZA EL PROCEDIMIENTO PARA LA DESIGNACIÓN DE LOS DEFENSORES ADJUNTOS..... --}}
        <section >
            <ul>
                <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                    <article>
        ...
        {{--VISITA DEL ALCALDE DE LISBOA A LA LEGISLATURA..... --}}
        <section >
            <ul>
                <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                    <article>
   ...
   <section >
    ...
    <section >
        ...
        <br><br>
         ...
         {{-- ARIEL ARDIT ES NUEVA PERSONALIDAD DESTACADA DE LA CIUDAD --}}
    <section >
        <ul>
            <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                <article>
                    ...
                    <div class="py-4 px-4 justify-between items-center">
                        ...
                        <div
                            ...
                            <div class=" font-sans text-lg text-left col-span-6  ">
                                ...
                                <p><strong> La Legislatura de la Ciudad, a través de sus diputados, declaró como
                                    Personalidad Destacada en el ámbito de la Cultura al cantor de tango,
                                    Ariel Ardit.</strong> El acto se realizó dentro del<strong> Salón Dorado</strong> del Palacio Legislativo
                                    y contó con<strong> la presencia del legislador y autor del proyecto Javier
                                    Andrade, el homenajeado, los periodistas Horacio Pagani y Walter Nelson,
                                    el ex futbolista Carlos Babington y demás personalidades del tango.
                                    Además se realizaron varios números musicales.</strong></p>
                                <br>


                                <p>En tanto que Ardit sintetizó: “Acá me hice cantor de tango y donde nacieron mis
                                    hijas y hoy estoy con los que quiero estar. Ustedes son esta vida que tengo en
                                    Buenos Aires y no tengo nada más que decir, solo seguir cantando”.</p>
                                <br>

                                <p>Luego, Nelson contó: “Se me entremezclan un montón de sentimientos, el
                                    destino nos cruzó de casualidad. El tango estuvo en mi sangre desde chico, al
                                    igual que el fútbol y el boxeo”. Mientras que Babington categorizó: “Él es un
                                    crack, Ariel tiene esa mezcla de gusto, de voz, de carisma, de escenario que lo
                                    hace ser el Gardel del siglo XXI”.</p>
                                <br>

                                <p>Finalmente Pagani recordó cómo conoció a Ardit por una recomendación y
                                ...
                                <br>
                                <p>Ariel Ardit, nacido en Córdoba en mayo del 1974 y criado en el epicentro de la
                                    Ciudad de Buenos Aires desde sus ocho años de edad, es hoy en día una de
                                    las caras principales del tango porteño. Con una trayectoria llena de logros y
                                    premios a nivel nacional e internacional, Ariel Ardit sabe como representar a
                                    uno de los grandes emblemas de nuestra cultura. El tango es una identidad
        ...
        <br><br>
          ...
          {{-- EL MÚSICO MIGUEL DE CARO ES NUEVA PERSONALIDAD.... --}}
  <section >
    <ul>
        <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
            <article>
                    ...
                    <div
                        ...
                        <div class=" font-sans text-lg text-left col-span-6  ">
                            ...
                            <p><strong> Los legisladores de la Ciudad declararon al compositor,
                                    ...
                                    Destacada en el ámbito de la Cultura.</strong> Con la presencia del<strong>
                                    diputado y autor del proyecto, Matías Barroetaveña, y del
                                    periodista y presidente de la Academia Nacional del Tango,
                                    Gabriel Soria</strong>, se llevó a cabo en el<strong> salón San Martín.</strong> Y donde
...
<br><br>
  {{-- MATÍAS NAPP ES NUEVA PERSONALIDAD DESTACADA --}}
  <section >
    <ul>
        <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
            <article>
                ...
                <div class="py-4 px-4 justify-between items-center">
                    ...
                    <div
                        ...
                        <div class=" font-sans text-lg text-left col-span-6  ">
                            ...
                            <p><strong> Los diputados de la Ciudad declararon al bailarín y coreógrafo,
                                Matías Napp, como Personalidad Destacada en el ámbito de la Cultura.</strong>
                                El acto se desarrolló en el<strong> Salón Dorado</strong> y contó con la
                                presencia del<strong> diputado y autor de la iniciativa, Roy Cortina, el
                            ...
                            <p>Al inicio de los discursos y después de dar la bienvenida al Palacio
                                ...
                                y que transmiten emociones a través del baile.<strong> “Matías nació en esta
                                ciudad y con cada uno de sus trabajos da vida y movimiento a las
                                calles de Buenos Aires”</strong>, remarcó el legislador.</p>
                            <br>

                            <p>Luego, el artista agradeció a Cortina por el proyecto:<strong> “Nunca pensé
                                que me podría llegar a pasar esto y todavía me cuesta creerlo”</strong>. A su
                                vez agregó:<strong> “Me interesa educar, de tener valores, respetar a la
                                persona, de motivarla y tener buena energía”</strong>. Y resaltó su amor por
                                la danza.</p>
                            <br>
...
<br><br>
  ...
  {{-- El cuerpo Legislativo reconoció al Director Santiago Mitre --}}
  <section >
    <ul>
        <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
            <article>
                ...
                <div class="py-4 px-4 justify-between items-center">
                    ...
                    <div
                        ...
                        <div class=" font-sans text-lg text-left col-span-6  ">
                            ...
                            <p>Los diputados declararon al director de cine, guionista y actor,<strong>
                                Santiago Mitre</strong>, como<strong> Personalidad Destacada en el ámbito de la
                                Cultura de la Ciudad</strong>. El acto se desarrolló esta tarde en el salón
                        ...
                        <div class="py-4 px-4 justify-between items-center">
                            ...
                            <div
                                ...
                                <div class=" font-sans text-lg text-left col-span-6  ">
                                    ...
                                    <p>La serie <strong>“El amor después del amor”</strong> obtuvo este miércoles la
                                    ...
                                    <p><strong>“En el contexto de los 40 años de la democracia ininterrumpida en
                                        Argentina, la serie narra de una forma muy conmovedora un paisaje de
                                        época donde la música, la cultura, la política y las calles
                                        transitaban la asfixia, la violencia y la persecución de la
                                        dictadura pero también el reverdecer de la apertura democrática. El
                                        rock nacional es como una suerte de banda sonora de esos años, de
                                        nuestra democracia”</strong>, marcó el legislador autor del proyecto.</p>
                                    <br>

                                    <p>Además, Socías señaló: <strong>“En la serie está planteada la idea de una
                                        relación dialéctica entre el contexto y el arte. El rock está como
                                        un vehículo para la liberación en esos años. Más que un
                                        reconocimiento, es un agradecimiento por haber hecho eso. Me parece
                                    ...
                                    <p>Juan Pablo Kolodziej, como uno de los principales productores de la
                                        obra, expuso en sus agradecimientos: <strong>“Este es uno de los ejemplos en
                                        los que se traslada que la cultura está por encima de todo. El cine
                                        y la televisión evangelizan cultura. Es muy importante poder seguir
                        ...
                        <div class="py-4 px-4 justify-between items-center">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 shrink-0 ">
                                <div class=" font-sans text-lg text-left col-span-6  ">
                                    ...
                                    <p><strong>“Qué bueno que la cultura popular ingrese a esta majestuosa sala,
                                        donde se reconocen a los artistas de otros niveles culturales”,
                                        comentó Morresi en el comienzo de las alocuciones. Luego puntualizó
                                        ...
                                        rememoró: “ <strong> de chico mi sueño fue hacer música, pero no para
                                        hacerme millonario o famoso. Al admirar bandas como Los Ramones o
                                        bandas tan moldeadoras de culturas y sociedades, siempre miré el
                                        poder transcender y marcar un antes y un después e inspirar gente”</strong>.
        ...
        <section >
            <ul>
                <li class=" bg-white rounded-lg shadow "> {{-- primera --}}
                    <article>
                        <figure>
                            <img class="w-full object-cover object-center mt-6" src="{{ asset('../img/L-3.svg') }}"
                                alt="">
                        </figure>
                        <div class="py-4 px-4 justify-between items-center">
                            <h2 class="text-xl font-serif  font-bold pb-6">
                                <a href="">La Fundación La Balandra es de Interés para la Ciudad</a>
                            </h2>
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 shrink-0 ">
                                <div class=" font-sans text-lg text-left col-span-6  ">
                                    <p>A través de un proyecto presentado por el legislador Roy Cortina, los diputados
                                        reconocieron las actividades de dicha fundación, centradas en el desarrollo,
                                        fomento
                                        y difusión de la narrativa argentina.</p>
                                    <P>El Cuerpo Legislativo de la Ciudad declaró de Interés para la Cultura a la
                                        Fundación
                                        La Balandra. El acto se desarrolló esta tarde, en el Salón Montevideo y contó
                                        con la
                                        presencia del diputado y autor de la iniciativa Roy Cortina, el presidente de
                                        dicha
                                        entidad y escritor Carlos Costa, la escritora e investigadora María Rosa Lojo y
                                        el
                                        secretario de la fundación Gastón Fiorda.</P>
                                    <P>En el inicio de las alocuciones, Cortina calificó a la cultura como uno de los
                                        símbolos de la Ciudad y que posicionó a Buenos Aires “a lo largo de los años por
                                        su
                                        oferta de las capitales culturales del mundo”. También recordó cómo conoció a la
                                        fundación y sumó: “En épocas donde la industria editorial está siendo atravesada
                                        por
                                        las nuevas tecnologías y lastimosamente por los costos que implica la impresión,
                                        Carlos decidió involucrarse y poner el cuerpo”. Y calificó a La Balandra como
                                        “un
                                        modelo de compromiso con la cultura y con nuestra Ciudad”.</P>
                                    <P>A su turno, Costa recordó los inicios de la institución y contó de sus avances.
                                        Además agregó: “Creamos una comunidad y el ser una comunidad nos da mucha fuerza
                                        ante la sociedad y nos garantiza la continuidad de nuestro oficio”. Y con la
                                        distinción atribuyó que se “ganó un paso” y que es un aporte muy importante.</P>
                                    <P>Por su parte, Lojo resaltó la plataforma de La Balandra y puntualizó: “Su
                                        lanzamiento
                                        abrió todo un mundo que antes hubiera sido impensado. Nos honra a todos los que
                                        formamos parte de este grupo de amigos y de este club en que se ha convertido La
                                        Balandra en lo largo y ancho de la Argentina”. 📚 Finalmente Fiorda concluyó que
                                        la
                                        literatura es un lugar de encuentro y un fenómeno colectivo.</P>
                                    <P>En 2019, el escritor entrerriano Carlos Costa concibió la Fundación la Balandra
                                        con
                                        el objetivo de contribuir al desarrollo, fomento y difusión de la narrativa
                                        argentina. Para lograr esto, la Fundación lleva a cabo varias actividades como,
                                        por
                                        ejemplo; certámenes y concursos literarios, subsidios a ediciones de autores
                                        argentinos, seminarios, coloquios, conferencias y congresos de escritores.
                                        Además de
                                        brindar servicios como corrección de estilo, diseño e impresión para noveles
                                        escritores y talleres de estrategia de difusión y promoción de obras.</P>
                                    <P>Por sus páginas han pasado Abelardo Castillo, Luisa Valenzuela, Mempo
                                        Giardinelli,
                                        Liliana Heker, J. M. Coetzee, Mariana Enríquez, Guillermo Martínez, Claudia
                                        Piñeiro,
                                        Andrés Neuman, Sylvia Iparraguirre, Carlos Gamerro, Hernán Ronsino, Fernanda
                                        García
                                        Lao, Flavia Pittella, Mónica Maristain y Osvaldo Quiroga, entre muchísimos
                                        otros.
                                    </P>
                                    <br><br>
                                </div>
                ...
                <li class=" bg-white rounded-lg shadow ">
                    <article>
                        <figure>
                            ...
                            <img class="w-full object-cover object-center" src="{{ asset('../img/L-4.svg') }}"
                                alt="">
                        </figure>
                        <div class="py-4 px-4 justify-between items-center">
                            <h2 class="text-xl font-serif  font-bold pb-6">
                                <a href="">El Cuerpo Legislativo destacó a Proyecto 7 – Gente en Situación de
                                    Calle</a>
                            </h2>
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 shrink-0 ">
                                <div class=" font-sans text-lg text-left col-span-6  ">
                                    <p>Por medio de un proyecto de la diputada Cecilia Segura Rattagan, la Legislatura
                                        reconoció la labor de la organización social, que acompaña y asiste a personas
                                        en
                                        situación de calle.</p>
                                    <P>Los legisladores de la Ciudad declararon de Interés Social a la organización
                                        social
                                        “Proyecto 7 – Gente en Situación de Calle”. El acto se llevó a cabo en el salón
                                        Hipólito Yrigoyen y contó con la presencia de la diputada y autora del proyecto
                                        Cecilia Segura Rattagan y distintos resentantes de dicha organización.</P>
                                    <P>En el comienzo, Segura Rattagan agradeció la presencia de todas las
                                        organizaciones y
                                        argumentó el merecimiento de la distinción: “Proyecto 7 ha sido vanguardia con
                                        todo
                                        lo que ha construido para generar y crear soluciones en torno a este problema,
                                        después de 20 años de su nacimiento”. Además ahondó: “Es una organización
                                        política y
                                        social, pero que sobre todo trabaja en la creación de políticas públicas para
                                        abordar este problema de situación de calle, la expresión más dolorosa de la
                                        problemática habitacional de la Ciudad de Buenos Aires”.</P>
                                    <P>“Pasé por un coma, por un estado vegetativo, anduve en silla de ruedas, anduve en
                                        muletas y en bastón y gracias a Proyecto 7 me levanté”, puntualizó Octavio Oscar
                                        Soria, integrante de la institución y muchas de las voces que se hicieron
                                        presentes
                                        en la Legislatura de la Ciudad.</P>
                                    <P>Proyecto 7 cuenta con una amplia trayectoria y experiencia en el abordaje,
                                        acompañamiento, atención y asistencia hacia personas en situación de calle,
                                        promoviendo y protegiendo sus derechos. Al tiempo de procurar propiciar
                                        oportunidades para revertir su situación y evitando que se cronifiquen en un
                                        círculo
                                        vicioso que oscila entre la calle, los paradores y los hoteles.</P>
                                    <P>Es una de las organizaciones que impulsó fuertemente la sanción de la Ley 3706 de
                                        protección de los derechos de las personas en situación y riesgo a la situación
                                        de
                                        calle. Esta reglamentación fue sancionada en diciembre del año 2010, y refleja
                                        los
                                        acuerdos alcanzados con organizaciones que cuentan con reconocida trayectoria y
                                        trabajo con personas en situación de calle como Proyecto 7. A su vez, Proyecto 7
                                        participó de la organización, planificación y ejecución de los dos censos
                                        populares
                                        de personas en situación de calle de la Ciudad de Buenos Aires, realizados en
                                        2017 y
                                        2019.</P>
            ...
            <ul>
                <li class=" bg-white rounded-lg shadow "> {{-- primera --}}
                    <article>
                        ...
                        <figure>
                            <img class="w-full object-cover object-center mt-6" src="{{ asset('../img/L-1.svg') }}"
                                alt="">
                        </figure>
                        <div class="py-4 px-4 justify-between items-center">
                             <h2 class="text-xl font-serif  font-bold pb-6">
                                <a href="">El Cuerpo Legislativo reconoció dos libros </a>
                            </h2>
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 shrink-0 ">
                                <div class=" font-sans text-lg text-left col-span-6  ">
                                    <p>A través de las iniciativas de los legisladores Laura Velasco y Matías
                                        Barroetaveña, el Cuerpo Legislativo entregó dos diplomas a las publicaciones
                                        “Vaivenes de la ternura. ESI en el nivel inicial", de Liliana Maltz, y a
                                        “Periodistán, un Argentino en la Ruta de la Seda” del autor Fernando Duclos.</p>
                                    <p>Los legisladores de la Ciudad declararon de Interés para la promoción de los
                                        Derechos de las mujeres, géneros y diversidades al libro "Vaivenes de la
                                        ternura. ESI en el nivel inicial", de Liliana Maltz. Y a la publicación
                                        “Periodistán, un Argentino en la Ruta de la Seda” de, Fernando Duclos, de
                                        Interés para la Comunicación Social y Promoción. Los proyectos fueron
                                        presentados por los diputados Laura Velasco y Matías Barroetaveña,
                                        respectivamente.</p>
                                    <p>El primer acto se llevó a cabo en el salón Arturo Jauretche y contó con la
                                        presencia tanto de la diputada como de la autora del libro. “La ESI trabaja en
                                        intersección entre la educación y las temáticas de género, entre muchas otras
                                        cosas. Y entre muchos otros lugares, donde va tejiendo esos entramados que
                                        pretenden ayudarnos a avanzar a un cambio cultural para que podamos tener una
                                        sociedad donde no estemos tan en desventaja las mujeres y diversidades”,
                                        puntualizó Velasco.</p>
                                    <p>A su turno, Maltz agradeció a la diputada y a la Legislatura el reconocimiento,
                                        como también la presencia de quienes llenaron el salón. “También le tengo que
                                        decir gracias a la ESI, porque en lo personal me ayudó a revisarme, a
                                        replantearme, a incomodarme, a hacerme preguntas y eso es la ESI. Y también a
                                        aceptar mejor mis propios alberques”.</p>
                                    <p>La obra analiza las resistencias y los apoyos a la Educación Sexual Integral
                                        (ESI). No solo para visibilizarlo, sino también para elaborar estrategias que
                                        permitan avanzar en su implementación en cada escuela. A través de sus once
                                        capítulos, se recorren algunos vaivenes. Vaivenes que acercan, donde se
                                        reflexiona, se comparten testimonios, proyectos y propuestas en las que los
                                        temores devienen en confianza. También vaivenes que alejan, donde se leen
                                        acusaciones por "homosexualizar" a las niñeces, tensiones que surgen de las
                                        miradas adulto céntricas y malestares por hablar en lenguaje inclusivo.</p>
                                    <p>Luego, el Salón Alfonsín fue el escenario para la distinción al libro
                                        “Periodistán, un Argentino en la Ruta de la Seda”, que tuvo las alocuciones del
                                        diputado Barroetaveña y del autor Fernando Duclos.</p>
                                    <p>“Muchas gracias al legislador Barroetaveña por la iniciativa y a los que
                                        siguieron los hilos de Twitter. Es un honor muy grande”, comentó el autor.
                                        También confesó que en su viaje, los lugares que más lo sorprendieron
                                        “justamente fueron los que no se parecían a Argentina”. Y ahondó en las memorias
                                        y los recuerdos que le dejó su aventura, como también en las diferencias
                                        socio-culturales entre Occidente y Oriente.</p>
                                    <p>El libro retrata el viaje que hizo Fernando Duclos por la histórica ruta de la
                                        seda, que unía el mediterráneo con India y China. El periodista partió por
                                        Barcelona, para seguir por Los Balcanes, Moldavia, Georgia, Rusia, Ucrania,
                                        Uzbekistán, Afganistán, Kirguistán e Irán, pasando por países casi desconocidos
                                        como Transnistria. El inicio de la pandemia lo encontró en pleno periplo y debió
                                        regresar al país.</p>
                                    <p>Sin embargo, esta larga aventura quedó documentada en cientos de hilos de Twitter
                                        de su cuenta @periodistan_ y tuvo una gran repercusión en medios nacionales e
                                        internacionales. Que finalmente quedaron documentos en este ejemplar, se ha
                                        convertido en una fuente ineludible para acercarse las sociedades de medio
                                        oriente, y sobre todo, una mirada libre de prejuicios sobre el mundo musulmán.
                                    </p>
                                    <br><br>
                                </div>
        ...
        <section>
            <ul>
                <li class=" bg-white rounded-lg shadow "> {{-- primera --}}
                    <article>
                        <figure>
                            <img class="w-full object-cover object-center" src="{{ asset('../img/L-2.svg') }}"
                                alt="">
                        </figure>
                        <div class="py-4 px-4 justify-between items-center">
                            <h2 class="text-xl font-serif  font-bold pb-6">
                                <a href="">Betiana Blum es nueva Personalidad Destacada de la Ciudad </a>
                            </h2>
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 shrink-0 ">
                                <div class=" font-sans text-lg text-left col-span-6  ">
                                    <p>Los legisladores reconocieron la trayectoria de la reconocida actriz, a través de
                                        un
                                        proyecto presentado por Diego Weck.</p>
                                    <p>El Cuerpo Legislativo de la Ciudad declaró como Personalidad Destacada en el
                                        ámbito
                                        de la Cultura a la actriz Betiana Blum. El acto se llevó a cabo en el Salón
                                        Dorado y
                                        contó con la presencia del diputado y autor de la iniciativa Diego Weck, el
                                        director
                                        Marcos Carnevale, el empresario teatral Carlos Rottemberg, los actores Facundo
                                        Arana
                                        y Sergio Surraco y la homenajeada.</p>
                                    <p>En el comienzo de las alocuciones, Weck dio la bienvenida a “esta casa de la
                                        democracia”. Luego destacó: “El rol de los actores es muy importante en esta
                                        sociedad y el de Betiana ha sido fundamental en los años democráticos”. Y sumó:
                                        “Ella es una de las representantes más importantes. Es un ejemplo de vida y de
                                        trayectoria para las generaciones futuras”.</p>
                                    <p>Luego Blum agradeció al diputado Weck y a la Legislatura por la distinción.
                                        También
                                        rememoró sus comienzos en la actuación: “El origen de que esté parada aquí es el
                                        amor que desde niña tuve por la palabra y por el verbo”. Y determinó: “Tengo un
                                        gran
                                        amor por la profesión y me di cuenta en el transcurso de la vida. La mayor
                                        cantidad
                                        de tiempo de mi vida se la dediqué a la profesión y no me arrepiento”.</p>
                                    <p>Por su parte, Carnevale distinguió la vocación, el talento y el “deseo
                                        irrefrenable”
                                        de vivir de la actriz. En tanto que Rottemberg puntualizó en su talento e
                                        inteligencia, “que son dos cualidades que corren por cuerdas separadas y ella
                                        tiene
                                        las dos y que la hace moverse a través de una trayectoria extensa sin demasiados
                                        rodeos”.</p>
                                    <p>Por último, Arana recordó sus inicios en la actuación y la influencia de Blum:
                                        “La
                                        oportunidad vino directamente de tu mano. Nunca me voy a olvidar la pasión, la
                                        dedicación, el esmero, el amor, la paz y la seguridad que me diste tanto a mi
                                        como a
                                        cada una de esas almas que queríamos ir con la actuación”.</p>
                                    <p>Mientras que Surraco concluyó: “Es una gran persona que me enseñó muchas cosas de
                                        la
                                        vida. No solo a decir bien un texto, sino a enseñarte con cada vivencia y en
                                        cómo
                                        ella en su profesión trataba al otro o generaba una alegría en el público”.</p>
                                    <p>Betiana Blum es una de las actrices más emblemáticas del país, con más de treinta
                                        películas en su haber. Debutó en 1964 en Sombras en el cielo y de esta manera
                                        comenzaba un camino de éxitos ininterrumpidos. “Nuestra Galleguita”, trasmitida
                                        por
                                        Canal 9, fue el primer personaje con continuidad en televisión.</p>
                                    <p>En 1985 interpretó a la inolvidable Nora Musicardi en “Esperando la Carroza”, un
                                        clásico inolvidable para todos. Considerada como una de las películas más
                                        recordadas
                                        tanto sus personajes como muchos diálogos que son conocidos de memoria.</p>
                                    <p>Su filmografía da cuenta de una versatilidad asombrosa con películas como“Bodas
                                        de
                                        cristal”, “Un mundo de amor”, “Los Irrompibles”, “Bajo bandera”, “Atrapadas”,
                                        “Esa
                                        maldita costilla” y “De eso no se habla”. En cinco décadas de ciclos televisivos
                                        fue
                                        variando entre unitarios, novelas y series, los cuales dieron cuenta de la
                                        infinidad
                                        de personajes interpretados a lo largo de toda su trayectoria.</p>
