...
{{-- ATE EXIGE PARAR LOS DESPIDOS EN EL MINISTERIO DE JUSTICIA --}}
<section>
            <ul>
...
{{--LA CTA DENUNCIA EL AUMENTO HISTÓRICO DE LA POBREZA  --}}
<section>
                    <ul>
                        <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                            <article>
...
{{--AUMENTO DEL SUBTE Y DENUNCIAS POR PELIGRO EN LA LÍNEA B  --}}
<section>
                    <ul>
                        <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                            <article>
...
{{-- TRABAJADORES DE AEROLÍNEAS ARGENTINAS PROTESTAN CONTRA PRIVATIZACIÓN --}}
<section>
...
{{-- CGT Y UNIVERSITARIOS UNIDOS CONTRA EL VETO A LA EDUCACIÓN --}}
<section>
                    <ul>
                        <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                            <article>
...
{{-- EL PAPA FRANCISCO IMPULSA LA DEFENSA DEL TRABAJO ANTE LA CGT  --}}
<section>
                    <ul>
                        <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                            <article>
...
{{-- MILEI VULNERA LOS DERECHOS LABORALES DE LOS AERONÁUTICOS --}}
<section>
                    <ul>
                        <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                            <article>
    ...
    {{--PRIMERA REUNIÓN DEL PAPA CON LA CÚPULA DE LA CGT EN SEPTIEMBRE --}}
    <section>
        <ul>
            <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                <article>
    ...
    {{--EL GOBIERNO DESPIDE TRABAJADORES POR MOTIVOS IDEOLÓGICOS  --}}
    <section>
        <ul>
            <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                <article>
    ...
    {{--CTA RECHAZA VETO DE MILEI A LA LEY DE MOVILIDAD PREVISIONAL  --}}
    <section>
        <ul>
            <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                <article>
    ...
    {{--CORREA INAUGURÓ LA SUBDELEGACIÓN DE EZEIZA CON GRANADOS Y MOYANO  --}}
    <section>
        <ul>
            <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                <article>
    ...
    {{--MOYANO DENUNCIA ATAQUE A CAMIONEROS POR PARTE DE CABA  --}}
    <section>
        <ul>
                            <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                                <article>
        ...
        {{--Plenario Nacional de la CTA-T con Axel Kicillof  --}}
    <section>
        <ul>
            <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                <article>
        ...
        {{--LA CGT CONTRAATACA: BATALLA LEGAL POR LOS SALARIOS  --}}
    <section>
        <ul>
            <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                <article>
        ...
        {{--PARO NACIONAL DE ACEITEROS CONTRA LA LEY BASES  --}}
    <section>
        <ul>
            <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                <article>
        ...
        {{--LA CGT REPUDIA LA VIOLENCIA CONTRA MANIFESTANTES  --}}
    <section>
        <ul>
            <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                <article>
        ...
        {{--CTA DENUNCIA AL GOBIERNO DE MILEI ANTE LA OIT  --}}
    <section>
        <ul>
            <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                <article>
    ...
    <section>
        ...
        {{--ATE LEGISLATURA HIZO UNA NUEVA ENTREGA DE LOS PREMIOS A LOS DERECHOS HUMANOS JORGE MORRESI  --}}
    <section>
        <ul>
            <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                <article>
                ...
                <li class=" bg-white rounded-lg shadow mb-2"> {{-- primera --}}
                    <article>
                        ...
                        <div class="py-4 px-4 justify-between items-center">
                            ...
                            <br>
                            <p><strong> “Para nosotros eran urgentes y necesarias estas medidas aunque creemos que se
                                quedan a mitad de camino”</strong>, evaluó. En relación a lo anunciado para
                                trabajadores del Estado explicó que<strong> “$60.000 era lo que solicitábamos como
                            ...
                            <div
                                ...
                                <div class=" font-sans text-lg text-left col-span-6  ">
                                    <p>También se refirió a la situación particular de municipales y
                                        provinciales, entre quienes están<strong> “los más afectados hoy en el
                                        universo de trabajadores estatales”</strong> porque muchos<strong> “ni siquiera
                                        tienen convenio colectivo de trabajo”. “Habrá que asegurarse que el
                                    ...
                                    <br>
                                    <p><strong> “En el caso de los trabajadores que reciben el Salario Social
                                        Complementario, la respuesta es más limitado porque son 20 mil pesos
                                        en dos cuotas”</strong>, mientras que<strong> “para los monotributistas de primera
                                        categoría no llegan a 2 mil pesos por día”</strong>, agregó Godoy sobre los
                                        sectores más precarizados de las y los trabajadores.
                                    </p>
                                    <br>
                                    <p><strong> “El Gobierno está encaminado pero se queda a mitad de camino”,
                                        insistió el dirigente y señaló que el paquete quedó “limitado por
                                        los condicionamientos e imposiciones del FMI”</strong>. “El plan del FMI es
                                    ...
                                    <p>Por otra parte, el dirigente solicitó que se adelante la convocatoria
                                        al Consejo del Salario porque<strong> “necesitamos que se aumente”</strong> el
                                    ...
                                    <p>Finalmente, evaluó que los candidatos presidenciales Javier Milei (La
                                        Libertad Avanza) y Patricia Bullrich (Juntos por el Cambio)<strong> “son
                                        anti-trabajadores y no les interesa las condiciones de vida de
                                        nuestro pueblo”. “Que esos sectores neoliberales que reivindican a
                                        Cavallo, a Macri, a Menem, puedan volver al Gobierno es la
                                        demostración muy cabal de que este Gobierno viene muy retrasado a
                                        nivel nacional a dar las respuestas que el pueblo que lo llevo al
        ...
        <section >
            <ul>
                <li class=" bg-white rounded-lg shadow "> {{-- primera --}}
                    <article>
                        <figure>
                            <img class=" w-full object-cover" src="{{ asset('../img/G-4.svg') }}" alt="">
                        </figure>
                        <div class="py-4 px-4 ustify-between items-center">
                            <h2 class="text-xl font-serif  font-bold pb-6">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 shrink-0 ">
                                <div class="font-sans text-lg text-left col-span-6">
                                    <p>La docencia de la provincia de Buenos Aires y de CABA paran el martes 25 y el
                                        miércoles 26 contra el ajuste educativo y por la reapertura de las
                                        paritarias
                                    </p>
                                    <p>El martes y miércoles próximo los Sutebas Multicolores van al paro, en el
                                        marco
                                        de una enorme disconformidad de la docencia frente a la pulverización del
                                        salario en medio de la actual estampida inflacionaria, que ha sepultado el
                                        magro
                                        acuerdo firmado por la dirección celeste de Roberto Baradel en marzo pasado,
                                        que
                                        mientras hace campaña por la reelección del gobernador Axel Kicillof deja
                                        pasar
                                        un ajuste histórico contra la educación de la provincia. </p>
                                    <p>Las medidas de fuerza coincidirán con un paro del sindicato de la Ciudad de
                                        Buenos Aires Ademys (martes 25), también por la reapertura de las paritarias
                                        y
                                        la avanzada antieducativa de la ministra Soledad Acuña, y ambos sectores
                                        marcharán al Ministerio de Educación Nacional, el Palacio Pizzurno, para
                                        hacer
                                        oír sus reclamos a las autoridades nacionales, el martes 25 a las 15 hs.</p>
                                    <p>Además del reclamo de un salario familiar que en un cargo cubra la canasta
                                        familiar indexado por inflación, los gremios multicolores paran en defensa
                                        de
                                        las condiciones de trabajo contra el avance de una reforma laboral de hecho
                                        que
                                        está destruyendo el estatuto docente, por infraestructura y obras que no
                                        existen, creación de todos los cargos faltantes, contra el vaciamiento de
                                        las
                                        obras sociales y de sus prestaciones, becas para todes les estudiantes y
                                        comedores universales en las escuelas, defensa de los derechos jubilatorios
                                        y
                                        por el aumento del presupuesto educativo y el fin del pago de la deuda
                                        externa.
                                        Un plan de lucha que enfrenta el ajuste general de los gobiernos en
                                        cumplimiento
                                        de los pactos y exigencias con el FMI.
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <ul>
                <li class=" bg-white rounded-lg shadow "> {{-- primera --}}
                    <article>
                        ...
                        <div class="py-4 px-4 justify-between items-center">
                            <h2 class="text-xl font-serif  font-bold pb-6">
                                <a href="">CLARIN NO CUMPLE LA LEY: SIPREBA CONVOCA CONFERENCIA DE PRENSA. Este
                                    martes 18/4 (¡mañana!) a las 9 hs. en Tacuarí 1800, frente a la redacción de Clarín.
                                </a>
                            </h2>
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 shrink-0 ">
                                <div class="font-sans text-lg text-justify col-span-6  ">
                                    <p>Ante la falta de avances en el conflicto por los despidos masivos en Clarín y en
                                        el
                                        marco de la jornada de lucha salarial convocada por la Federación Argentina de
                                        Trabajadores de Prensa (Fatpren), desde SiPreBA convocamos a una conferencia de
                                        prensa con trabajadoras y trabajadores despedidos de AGEA.</p>
                                    <p>Durante el lunes 17, la empresa Clarín/AGEA no cumplió con la ley: no acató la
                                        conciliación obligatoria, no permitió a les compañeres que pretende despedir
                                        realizar sus tareas de forma habitual, ni se presentó en la audiencia frente al
                                        Ministerio de Trabajo de la Nación. </p>
                                    <p>En la conferencia de prensa daremos más detalles, informaremos el estado de
                                        situación
                                        y los pasos a seguir. Además, tal como habíamos votado en asamblea general del
                                        SiPreBA, durante la jornada realizaremos asambleas en las demás redacciones
                                        nucleadas en SiPreBA en consonancia con la lucha salarial impulsada por FATPREN.
                                        .
                                    </p>
            ...
            <ul>
                <li class=" bg-white rounded-lg shadow "> {{-- primera --}}
                    <article>
                        ...
                        <div class="py-4 px-4 justify-between items-center">
                            <h2 class="text-xl font-serif  font-bold pb-6">
                                <a href="">Hugo Yasky “ Es mentira que con la inflación pierden todos, algunos
                                    ganan,
                                    y mucho" </a>
                            </h2>
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 shrink-0 ">
                                <div class=" font-sans text-lg text-left col-span-6  ">
                                    <p>En el Hotel ATE-UNL de la ciudad de Santa Fé se realizó el Plenario Nacional de
                                        la
                                        CTA, con una convocatoria multitudinaria de compañeras y compañeros de la
                                        Central de
                                        todo el país.</p>
                                    <p>Compartimos las palabras del Secretario General de la CTA y diputado nacional,
                                        Hugo
                                        ...
                                        José
                                        Testoni, Secretario General de CTA Santa Fe, Jorge Hoffmann, Secretario General
                                        de
                                        ATE-Santa Fe, Sonia Alesso, Secretaria General de CTERA: “Hoy comienza una serie
                                        de
                                        plenarios nacionales que se van a hacer en las distintas regiones del país.
                                        Empezamos en Santa Fe, a orillas del Paraná, un debate para definir un plan de
                                        acción nacional en un momento en que la Argentina ha entrado en un año electoral
                                        y
                                        que va a ser trascendente para los trabajadores”.</p>
                                    <p>Yasky señaló ante los medios de prensa, que “el cierre del Consejo del Salario no
                                        ...
                                        durante la
                                        pandemia”, Al mismo tiempo, destacó que “se incorporó nuestra propuesta de que
                                        la
                                    ...
                                    <p>El Diputado Nacional anticipó: “Vamos a discutir las acciones gremiales que
                                        ...
                                        algunos
                                        puntos por encima de la inflación. Ese es el objetivo”. Otro eje del debate que
                                        anunció Yasky, “lo va a motorizar el compañero Claudio Marín, secretario gremial
                                        de
                                    ...
                                    <p>Ante la consulta de los medios presentes Yasky afirmó que: “la inflación es el
                                        principal flagelo que sufren los trabajadores. Cuando dicen que con la inflación
                                        pierden todos, es mentira. Hay sectores que ganan y mucho”. Y agregó, “el
                                        acuerdo
                                        con el FMI es inflacionario porque exige tarifas y tasas de interés que llevan
                                        los
                                        precios hacia arriba. Por eso, en forma paralela y complementaria a las
                                        paritarias
                                        reclamamos una suma fija porque los efectos económicos actuales lo exigen.”</p>
                                    <p>Sobre el escenario político en un año electoral, el representante gremial
                                        consideró
                                        que, “sin unidad del campo popular tenemos un panorama negro, pero debe ser una
                                        unidad con contenido. Tenemos que decir qué vamos a hacer con FMI, cómo vamos a
                ...
                <li class=" bg-white rounded-lg shadow "> {{-- primera --}}
                    <article>
                        ...
                        <div class="py-4 px-4 justify-between items-center">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 shrink-0 ">
                                <div class=" font-sans text-lg text-left col-span-6  ">
                                    <p>WASIEJKO: “NO VAMOS A TOLERAR QUE UNOS POCOS SE APROPIEN DE LOS RECURSOS DE LAS Y
                                        LOS
                                        ARGENTINOS”</p>
                                    <p>Este jueves integrantes de la Federación de Trabajadores de la Industria,
                                        Energía,
                                        Servicios y Afines (FeTIA-CTA) que conduce Pedro Wasiejko, se reunieron en la
                                        CTA de
                                        los Trabajadores y Trabajadoras con Julio Urien para ultimar detalles de lo que
                                        será
                                        la participación de esta entidad en la Séptima Marcha por la Soberanía a Lago
                                        ...
                                        sociales,
                                        sindicales y políticas en defensa del territorio, los recursos y los derechos de
                                        las
                                        y los argentinos. En el encuentro estuvieron presentes Edgardo Depetri, titular
                                        del
                                        Frente Transversal y secretario de Asistencia Social en la Fetia y Rubén Ciuró,
                                    ...
                                    <p>En el encuentro Julio Urien detalló que “a partir de este viernes habrán
                                        ...
                                        organizaciones, tanto de la CTA de las y los Trabajadores, de la CTA Autónoma,
                                        de la
                                        ...
                                        sábado
                                        por la mañana va a entrar el primer contingente y a partir del lunes empezamos a
                                        concentrar para tratar de ingresar por el camino de Tacuifí. Los dos caminos
                                        están
                                        bloqueados por la gente que responde a Joe Lewis”. Y agregó: “Ellos no respetan
                                        las
                                        leyes, son el poder. Ahora nosotros con movilizaciones vamos a demostrar que el
                                        poder popular también existe. Yo creo que esta acción muestra la coordinación
                                        entre
                                        distintos sectores del campo popular y nacional que en la acción nos empezamos a
                                        coordinar y movilizar de forma pacifica, ponemos el cuero ante sus agresiones
                                        con la
                                        voluntad de defender nuestra soberanía”</p>
                                    <p>Pedro Wasiejko, titular de la FeTIA, aseguró que “desde hace años desde la FeTIA
                                        ...
                                        empresarios
                                        del Grupo Clarín. Casualmente son los mismos que persiguen a Cristina Fernández
                                        de
                                        Kirchner y emiten fallos que perjudican a las y los trabajadores. Tenemos que
                                        terminar con la impunidad de quienes creen que a través de la plata y las
                                        influencias pueden apropiarse del patrimonio de las y los argentinos. Vamos a
                                        seguir
                                        marchando y exigiendo que se abran los caminos públicos. No vamos a tolerar que
                                        unos
                                        pocos se apropien de los recursos de todos”, indicó.</p>
                                    <p>Por su parte, Edgardo Depetri manifestó que “la Marcha por la Soberanía a Lago
                                        Escondido representa una clara defensa de la soberanía nacional y pone de
                                        manifiesto
                                        uno de los grandes debates del momento actual que es la defensa de la democracia
                                        y
                                        la denuncia al pirata y estafador de nuestros bosques y lagos, Joe Lewis, que
                                        financió y organizó el escandaloso viaje de periodistas, funcionarios y jueces
                                        macristas y en cuya casa se escribió la sentencia y proscripción de la compañera
                                        Cristina Fernández de Kirchner”.</p>
                                    <p>Rubén Ciuró señaló que “este enclave británico en territorio nacional ha sido y
                                        es
                                        escenario de las tramas ocultas de la mafia judicial, las corporaciones y los
                                        funcionarios de Larreta. Marchamos al lago para defender nuestra democracia y la
                                        soberanía”.</p>
                                    <p>En el encuentro destacaron que a través de esta movilización, una vez más, se
                                        ...
                                        arbitren
                                        los medios para dar cumplimiento al fallo del Tribunal Superior de Justicia de
                                        la
                                        Provincia de Rio Negro y la Cámara de Bariloche que ordena habilitar los caminos
                                        de
                                        Tacuafí y el de Montaña del Cajón Azul para poder ingresar al lago público que
                                        fue
                                    ...
                                    <p>Silvana Franco, de la Mesa Nacional de la CTA-T acercó el respaldo y
                                        acompañamiento
                                        de la CONADU.</p>
                                    <p>Por otra parte, denunciarán la connivencia de sectores del sector político y de
                                        las
                                        fuerzas policiales con el empresario inglés que brindó sus instalaciones a
                                        jueces y
                                        fiscales nacionales para que se encuentren con los directivos del grupo Clarín y
                                        que
                                        llevó al gobierno nacional a presentar una denuncia penal por incumplimiento de
                                        los
                                        deberes de funcionario público, admisión de dádivas, ofrecimiento de dádivas y
                                        posible cohecho agravado de magistrados y/o tráfico de influencias agravado a
