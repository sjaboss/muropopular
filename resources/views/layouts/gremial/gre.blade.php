            ...
            <li class=" bg-white rounded-lg shadow "> {{-- segunda--}}
                <article>
                    <figure>
                        ...
                        <img class=" w-full object-cover" src="{{ asset('img/FOTOS SVG/policiales-1.svg') }}"
                            alt="">
